 ...
 * @version $Id: $
 */
public class ProductQuestionNotesAttachmentBackingBean extends ProductBackingBean {
	...
	public String getRecords() {
		...
		if(null!=this.questionNotes) return records;
			ProductQuestionNotesPopUpRequest request = getQuestionNotesPopUpRequest();
	...
	private ProductQuestionNotesPopUpRequest getQuestionNotesPopUpRequest(){
		ProductQuestionNotesPopUpRequest request = (ProductQuestionNotesPopUpRequest) this
		.getServiceRequest(ServiceManager.PRODUCT_QUESTION_NOTES_POPUP_REQUEST);
	...
	public String saveAction(){
		//Create request
		ProductQuestionNoteProcessRequest request = (ProductQuestionNoteProcessRequest) this
		.getServiceRequest(ServiceManager.PRODUCT_QUESTION_NOTES_PROCESS_REQUEST);
		...
		request.setPrimaryType(WebConstants.ATTACH_PRODUCT);
		...
		ProductQuestionNoteResponse response = (ProductQuestionNoteResponse) this
		.executeService(request);
