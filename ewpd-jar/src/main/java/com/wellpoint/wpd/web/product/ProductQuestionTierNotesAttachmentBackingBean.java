 ...
 * @version $Id: $
 */
public class ProductQuestionTierNotesAttachmentBackingBean extends ProductBackingBean {
	...
	/*
	 * method for loading notes attached to the tiered question .
	 * 
	 * 
	 */
	...
	public String saveAction(){
		//Create request
		ProductQuestionTierNoteProcessRequest request = (ProductQuestionTierNoteProcessRequest) this
		.getServiceRequest(ServiceManager.PRODUCT_QUESTION_TIER_NOTES_PROCESS_REQUEST);
