/*
 * ProdStructureAdminTreeNodeBase.java
 * 
 ...
 * @version $Id: $
 */
public class ProdStructureTreeAdminTreeNodeBase extends BaseTreeNode {

    public ProdStructureTreeAdminTreeNodeBase() {
        super();
    }
     ...
     * @param leaf
     */
    public ProdStructureTreeAdminTreeNodeBase(TreeModel treeModel,
    ...
    /**
     * Loads the effective and expiry dates for the product structure return
     * dateList
     *  
     */
