/*
 * ProductAdministrationTreeNodeBase.java
 * 
 ...
 * @version $Id: $
 */
public class ProductAdministrationTreeNodeBase extends ProductTreeNode {

    public ProductAdministrationTreeNodeBase(){
        super();
    }
     ...
     * @param leaf
     */
    public ProductAdministrationTreeNodeBase(TreeModel treeModel,
    ...
    //this method loads the benefitAdministrations
    /**
    ...
    protected List loadChildren()
    {
       ...
       //setting the required details to the Business Object
        ...
        for(int i=0;i<benefitAdministrationList.size();i++)
        {
            ...
            children.add(new ProductBenefitAdministrationTreeNodeBase(getModel(),this,"Benefit-Administration",benefitAdminId,bnftAdminName,false));
