 ...
 * @version $Id: $
 */
public class TaskMainTreeNodeBase extends BaseTreeNode {

    public TaskMainTreeNodeBase() {
        super();
    }
     ...
     * @param leaf
     */
    public TaskMainTreeNodeBase(TreeModel treeModel,
