 ...
 */
public class WPDMessageForPopupTag extends UIComponentTag {

    private String value;
    private static final String ERROR_MSG_COMP_TYPE = "ERROR_MSG_OUTPUT";
    private static final String ERROR_MSG_RENDER_TYPE = "ERROR_MSG_RENDERER_FOR_POPUP";
    
    /**
     *  
     */
    public WPDMessageForPopupTag() {
        super();
    }
