 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class ContractVariableMappingBO extends BusinessObject{
	...
	// SSCR19537 - April release - changes for bx data feed
	private String eb03Assn;
	...
	public String getEb03Assn() {
		return eb03Assn;
	}
	public void setEb03Assn(String eb03Assn) {
		this.eb03Assn = eb03Assn;
	}
