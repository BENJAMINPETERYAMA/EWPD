 ...
 */
public class ProductCheckBO extends BusinessObject {
	...
	/**
	 * @return Returns the productStructId.
	 */
	public int getProductStructId() {
		return productStructId;
	}
	/**
	 * @param productStructId The productStructId to set.
	 */
	public void setProductStructId(int productStructId) {
		this.productStructId = productStructId;
	}
}