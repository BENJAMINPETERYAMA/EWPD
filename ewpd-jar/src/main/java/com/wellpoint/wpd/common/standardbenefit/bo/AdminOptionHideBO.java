 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class AdminOptionHideBO {
	 ...
	 private int ansOvrdCstmzdSysId;
	...
	*/
	...
	/**
	 * @return Returns the ansOvrdCstmzdSysId.
	 */
	public int getAnsOvrdCstmzdSysId() {
		return ansOvrdCstmzdSysId;
	}
	/**
	 * @param ansOvrdCstmzdSysId The ansOvrdCstmzdSysId to set.
	 */
	public void setAnsOvrdCstmzdSysId(int ansOvrdCstmzdSysId) {
		this.ansOvrdCstmzdSysId = ansOvrdCstmzdSysId;
	}
}
