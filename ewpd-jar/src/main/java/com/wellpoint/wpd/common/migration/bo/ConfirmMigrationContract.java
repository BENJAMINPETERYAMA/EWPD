 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class ConfirmMigrationContract {
	...
	/**
	 * @return Returns the prodStrMapSysId.
	 */
	public int getProdStrMapSysId() {
		return prodStrMapSysId;
	}
	/**
	 * @param prodStrMapSysId The prodStrMapSysId to set.
	 */
	public void setProdStrMapSysId(int prodStrMapSysId) {
		this.prodStrMapSysId = prodStrMapSysId;
	}
}
