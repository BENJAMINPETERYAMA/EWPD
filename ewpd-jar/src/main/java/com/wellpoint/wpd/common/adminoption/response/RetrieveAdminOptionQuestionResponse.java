...
/**
 * Response for Retrieving Admin Option Question
 * 
 * @author US Technology Resources - www.ustri.com <br />
 * @version $Id: $
 */
public class RetrieveAdminOptionQuestionResponse extends WPDResponse {

    List associatedQuestionList = new ArrayList();
