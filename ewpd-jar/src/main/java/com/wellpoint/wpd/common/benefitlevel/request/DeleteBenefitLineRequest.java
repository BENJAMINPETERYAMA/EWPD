 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class DeleteBenefitLineRequest extends WPDRequest{
	
	private BenefitLineVO benefiLineVO;
	...
	/**
	 * @return Returns the benefiLineVO.
	 */
	public BenefitLineVO getBenefiLineVO() {
		return benefiLineVO;
	}
	/**
	 * @param benefiLineVO The benefiLineVO to set.
	 */
	public void setBenefiLineVO(BenefitLineVO benefiLineVO) {
		this.benefiLineVO = benefiLineVO;
	}
}
