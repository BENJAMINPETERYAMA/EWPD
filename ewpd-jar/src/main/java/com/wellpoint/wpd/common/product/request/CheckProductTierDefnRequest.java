 ...
 * @version $Id: $
 */
public class CheckProductTierDefnRequest extends ProductRequest{
	...
	private ProductBenefitGeneralInformationVO productTierDefinitionVO;
	
	/**
     * @return Returns the productTierDefinitionVO.
     */
    public ProductBenefitGeneralInformationVO getProductTierDefinitionVO() {
        return productTierDefinitionVO;
    }
	/**
	 * @param productTierDefinitionVO The productTierDefinitionVO to set.
	 */
	public void setProductTierDefinitionVO(
	        ProductBenefitGeneralInformationVO productTierDefinitionVO) {
	    this.productTierDefinitionVO = productTierDefinitionVO;
	}
