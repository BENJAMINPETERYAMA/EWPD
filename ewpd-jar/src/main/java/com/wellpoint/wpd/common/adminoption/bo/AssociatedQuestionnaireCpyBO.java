 ...
 * @version $Id: $
 */
public class AssociatedQuestionnaireCpyBO extends Questionnaire{
	 ...
	 private int qustnrDsplySeqNum;
	 
	 private int qstnrLvl;
	/**
	...
	/**
	 * @return Returns the qstnrLvl.
	 */
	public int getQstnrLvl() {
		return qstnrLvl;
	}
	/**
	 * @param qstnrLvl The qstnrLvl to set.
	 */
	public void setQstnrLvl(int qstnrLvl) {
		this.qstnrLvl = qstnrLvl;
	}
	/**
	 * @return Returns the qustnrDsplySeqNum.
	 */
	public int getQustnrDsplySeqNum() {
		return qustnrDsplySeqNum;
	}
	/**
	 * @param qustnrDsplySeqNum The qustnrDsplySeqNum to set.
	 */
	public void setQustnrDsplySeqNum(int qustnrDsplySeqNum) {
		this.qustnrDsplySeqNum = qustnrDsplySeqNum;
	}
}
