/*
 * BenefitComponentScheduleForTestRequest.java
 * 
...
/**
 * Request for Benefit Component Schedule for Test.
 * 
 * @author US Technology Resources - www.ustri.com <br />
 * @version $Id: $
 */
public class BenefitComponentScheduleForTestRequest extends WPDRequest {
   ...
   private BenefitComponentBO benefitComponentBO;
    ...
    public void validate() throws ValidationException {
    	if(-1 == this.benefitComponentVO.getBenefitComponentId()) 
    		throw new ValidationException("Benefit Component Id is missing",null,null);
    }
/**
