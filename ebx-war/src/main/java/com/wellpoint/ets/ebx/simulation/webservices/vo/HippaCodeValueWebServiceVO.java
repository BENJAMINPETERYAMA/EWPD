...
public class HippaCodeValueWebServiceVO implements Comparable<Object>{
		...
		public int compareTo(Object obj1) {
			int compare = 0;
			if(obj1 instanceof HippaCodeValueWebServiceVO){
				HippaCodeValueWebServiceVO hippaCodeObj1 = (HippaCodeValueWebServiceVO) obj1;
