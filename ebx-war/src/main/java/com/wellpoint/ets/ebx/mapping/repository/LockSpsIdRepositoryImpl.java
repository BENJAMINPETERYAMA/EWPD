...
public class LockSpsIdRepositoryImpl implements LockRepository{
	...
	private static final String BOLK_BUS_OBJ_KEY_ID = "BOLK_BUS_OBJ_KEY_ID";
	...
	public List retrieveLock(String className, String keyId) {
		...
		List lockList = lockRetrieveTableQuery.execute();				
	...
	protected class LockDeleteTableQuery extends SqlUpdate {
		...
		protected void update(Mapping mapping) {
			Object[] objs = new Object[] {mapping.getClass().getName(),mapping.getSpsId().getSpsId()};
			super.update(objs);
		}
	}
	/**
