...
/**
 * @author UST-GLOBAL Interface for Reference data Facade Layer
 * 
 */
public interface ReferenceDataFacade {
	 ...
	 * @param matchValue
	 * @return List
	 * Fetch all the catalog names matching the value
	 * 
	 */
...
/*************************Manage Header Rule EB03 Associations April 2012 Release SSCR14181 START ******************************/
	 ...
	 * @param HeaderRuleToEB03MappingVO
	 * @return List
	 * Returns all the possible header rules from the db. Also used in auto complete/look up popup
	 */
...
/*************************Manage Header Rule EB03 Associations April 2012 Release SSCR14181 END ******************************/	
	...
	//public List<ServiceTypeMappingVO> fetchLobMbuMapping (ServiceTypeMappingVO VOToFetch);
	/**
