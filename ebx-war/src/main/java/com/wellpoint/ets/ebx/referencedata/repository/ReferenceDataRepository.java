...
/**
 * @author UST-GLOBAL Interface for Repository
 * 
 */
public interface ReferenceDataRepository {
	 ...
	 * @return
	 */
	public ErrorCodeVO fetchExclusions(String roleCode);
