...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/referenceHpnData.js"></script>
...
{ 
	...
	{ 
		case 116 : 
			...
			event.keyCode = 0;
			var action ;
			action = "${context}/referencedata/showHPNReferenceDataManagePage.html";
...
{
    document.forms['referenceHpnDataValueForm'].action="../ebxspiderworkflow/back.html";
    document.forms["referenceHpnDataValueForm"].submit();
}
...
function fetchReferenceDataValue(isAdmin) {
		...
		if(key == null || key == ""){
			addErrorToNotificationTray('Please enter a HPN Catalog Name');
...
<form name="referenceHpnDataValueForm"  method = "POST">
	...
	<div id="referenceDataValueContainer">
		...
		<div id="referenceDataValueSectionOne">
	 		<div id="referenceDataValueTitleBarOne">
	 			<div class="headerTitleDataValue">HPN Reference Data Value</div>		 			 			 		
			</div>
			...
			<div class="exclusionSectionThreeSub">		
				<table class="dvcriteriatable" border="0" cellpadding="0" cellspacing="0" width="100%">
					...
					<tr>
						...
						<td style="width: 80px"><input type="text" class="inputbox65" id="secondaryCodeForSave" name="secondaryCodeForSave" maxlength="50"/></td>
						<td>&#160;</td>		 									
					</tr>
					<tr>
						<td colspan="3">&#160;</td>
