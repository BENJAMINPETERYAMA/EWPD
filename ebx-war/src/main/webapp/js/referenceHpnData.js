...
function deleteDataValue(primaryCode) {
	...
	var key = $("#catalogNameLocate").val().toUpperCase();
	if(key == null || key == ""){
		addErrorToNotificationTray('Please choose a HPN Catalog Name');
		openTrayNotification();
		return false;
	}
	document.getElementById('valueForSave').value = primaryCode;
	document.forms['referenceHpnDataValueForm'].action="../referencedata/checkItemMappings.html";
...
function saveAdditionalComments() {
	...
	if('update'==event) { 
		...
		document.forms['referenceHpnDataValueForm'].action="../referencedata/updateItem.html";
		document.forms['referenceHpnDataValueForm'].submit();
	} else if('delete'==event) {
		document.getElementById('valueForSave').value = $.trim($("#primaryCodeInDialog").val());
		document.forms['referenceHpnDataValueForm'].action="../referencedata/deleteItem.html";
		document.forms['referenceHpnDataValueForm'].submit();
	}
}
...
function createDataValue(catalogMinLength) {
	...
	document.forms['referenceHpnDataValueForm'].action="../referencedata/addItem.html";
	document.forms['referenceHpnDataValueForm'].submit();
}
