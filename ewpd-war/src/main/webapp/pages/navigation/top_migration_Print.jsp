...
<f:verbatim></TD></tr></table>
  ...
  <td width="50%" align="left">&nbsp;</f:verbatim>
		<h:outputText id="breadCrumb1" value="#{requestScope.breadCrumbTextLeft}"> </h:outputText><f:verbatim></td>

	
	<td width="50%" align="right"><b></f:verbatim><h:outputText id="breadCrumb3" value="#{requestScope.breadCrumbTextRight}"> </h:outputText>
	<f:verbatim>
	<a href="#"><img src="../../images/print.gif" alt="Print" border="0" onclick="printSelection();return false;"/> </a></td>
      </tr>
    </table>	
</f:verbatim>
