...
<%-- jsf:pagecode language="java" location="/JavaSource/pagecode/pages/contractpopups/Fundingargument.java" --%><%-- /jsf:pagecode --%>
<HTML>
<HEAD>
...
<f:view>
	<BODY>
	<h:form id="fundingArgumentPopupForm">
		<table border="0" cellpadding="5" cellspacing="0" width="100%">
			...
			<tr>
				<td align="left"><h:commandButton id="selectButton" value="Select"
					...
					onclick="getCheckedItems_ewpd('fundingArgumentPopupForm:fundingArgumentDataTable',2);return false;"></h:commandButton>
				</td>
			</tr>
		</table>
			...
			<TBODY>
					...
					<table width="100%" border="0" cellspacing="1" cellpadding="0"
						...
						<TR>
							<TD width="6%" align="left">
								<h:selectBooleanCheckbox onclick="checkAll_ewpd(this,'fundingArgumentPopupForm:fundingArgumentDataTable'); ">
								</h:selectBooleanCheckbox>
							</TD>
							<TD width="94%" align="center">
								<strong><h:outputText value="Funding Argument "></h:outputText></strong>
							</TD>
						</TR>
					</table>
					</TD>
				...
				<tr>
					...
					<h:dataTable rowClasses="dataTableEvenRow,dataTableOddRow" columnClasses="selectOrOptionColumn,shortDescriptionColumn"
						cellspacing="1" width="100%" id="fundingArgumentDataTable"
...
<script language="javascript">
	...
	if(hiddenObj.value) {
		...
		matchCheckboxItems_ewpd('fundingArgumentPopupForm:fundingArgumentDataTable', window.dialogArguments.selectedValues, 2, 2, 2);
	}
</script>
</HTML>
