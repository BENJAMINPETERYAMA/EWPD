...
<f:view>
	...
	<div id="noNotesDiv">
		<h:outputText value="No Notes Available."  rendered="#{notesAttachmentBackingBean.notes == null}"
				...
				<TBODY>
					...
					<tr>
						...
						<h:dataTable cellspacing="1" id="legacyNotesDataTable" 
							rendered="#{notesAttachmentBackingBean.legacyNotesList != null}"
							value="#{notesAttachmentBackingBean.legacyNotesList}" styleClass="outputText"
				...
				<TBODY>
					...
					<tr>
						...
						<h:dataTable cellspacing="1" id="wpdNotesDataTable" 
							rendered="#{notesAttachmentBackingBean.ewpdNotesList != null}"
							value="#{notesAttachmentBackingBean.ewpdNotesList}"
							var="singleValue" cellpadding="0" bgcolor="#cccccc"
							rowClasses="dataTableEvenRow,dataTableOddRow">
							<h:column>
							<f:verbatim>
...
<script language="javascript">
	...
	function viewAction(noteId,noteVersion,noteName){
		var url = '../popups/viewLegacyNoteDetails.jsp'+getUrl()+'?noteId='+noteId +'&&'+'noteName='+noteName+'&&version='+noteVersion;
