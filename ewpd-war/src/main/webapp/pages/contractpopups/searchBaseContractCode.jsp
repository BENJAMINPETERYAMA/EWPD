...
<%-- jsf:pagecode language="java" location="/JavaSource/pagecode/pages/contractpopups/SearchBaseContractCode.java" --%><%-- /jsf:pagecode --%>
<HTML>
<HEAD>
...
<f:view>
	...
	<h:form id="baseContractCodeForm">
		<h:outputText value="No Contracts Available." 
					rendered="#{contractPopupBackingBean.baseContractCode == null}" 
			...
			<TBODY>
				...
				<tr>
					...
					<DIV id="popupDataTableDiv" class=popupDataTableDiv><h:dataTable
						...
						value="#{contractPopupBackingBean.baseContractCode}"
