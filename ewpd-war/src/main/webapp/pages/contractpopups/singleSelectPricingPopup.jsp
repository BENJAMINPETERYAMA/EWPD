			...
			<tbody>
				...
				<tr id="tr1">
					...
					<h:dataTable rowClasses="dataTableEvenRow,dataTableOddRow" columnClasses="selectnetworkIdColumn,shortDescriptionColumn,longDescriptionColumn"
						cellspacing="1" width="100%" id="pricingDataTable1"
						value="#{ReferenceDataBackingBeanCommon.refDataLookUpList}"
                        rendered="#{ReferenceDataBackingBeanCommon.renderFirstList}" var="pricingValue"
						cellpadding="0" bgcolor="#cccccc">
						<h:column>
							<wpd:singleRowSelect groupName="pricing" id="pricingId"
								rendered="true"></wpd:singleRowSelect>
						</h:column>
						<h:column>
                           
							<h:inputHidden value="#{pricingValue.description}"></h:inputHidden>
							<h:inputHidden value="#{pricingValue.primaryCode}"></h:inputHidden>
  							<f:verbatim>&nbsp;</f:verbatim>
							<h:outputText value="#{pricingValue.primaryCode}"></h:outputText>
						...
						<h:column>
							...
							<h:outputText value="#{pricingValue.description}"></h:outputText>
						</h:column>
					</h:dataTable></DIV>
					</td>
				</tr>
                <tr id="tr2">
					...
					<h:dataTable rowClasses="dataTableEvenRow,dataTableOddRow" columnClasses="selectnetworkIdColumn,longDescriptionColumn,shortDescriptionColumn"
						cellspacing="1" width="100%" id="pricingDataTable2"
						value="#{ReferenceDataBackingBeanCommon.refDataLookUpList}"
                        rendered="#{!ReferenceDataBackingBeanCommon.renderFirstList}" var="pricingValue"
						cellpadding="0" bgcolor="#cccccc">
						<h:column>
...
document.getElementById('pricingForm:selectButton').disabled  = false;
matchCheckboxItems_ewpd('pricingForm:pricingDataTable1',window.dialogArguments.selectedValues,2,2,2);
matchCheckboxItems_ewpd('pricingForm:pricingDataTable2',window.dialogArguments.selectedValues,2,2,2);
var sort = document.getElementById('pricingForm:hiddensortorder');
...
if(sort != null && sort.value == 'code'){
	tigra_tables('pricingForm:pricingDataTable1',0,0,'#ffffff','#e1ecf7','#ffccff','#cc99ff');
    ...
    tigra_tables('pricingForm:pricingDataTable2',0,0,'#ffffff','#e1ecf7','#ffccff','#cc99ff');
...
getCheckedItems_ewpd('pricingForm:pricingDataTable1',2);return false;
}
else if(sort != null && sort.value == 'desc'){

getCheckedItems_ewpd('pricingForm:pricingDataTable2',2);return false;
}
}
