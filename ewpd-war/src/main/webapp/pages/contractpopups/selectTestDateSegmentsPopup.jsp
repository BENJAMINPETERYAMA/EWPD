...
<%-- jsf:pagecode language="java" location="/JavaSource/pagecode/pages/contractpopups/SelectTestDateSegmentsPopup.java" --%><%-- /jsf:pagecode --%>
<HTML>
<HEAD>
			...
			<TBODY>
				...
				<tr>
					<td><h:dataTable rowClasses="dataTableEvenRow,dataTableOddRow"
						...
						value="#{contractBasicInfoBackingBean.testDateSegmentOptionList}"
...
<script language="JavaScript">
	var tblobj1 = document.getElementById('dateSegmentPopupForm:groupSizePopupTable');
	if(tblobj1.rows.length > 0){
