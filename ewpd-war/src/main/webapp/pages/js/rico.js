...
Rico.Accordion.Tab.prototype = {
   ...
   showCollapsed: function() {
      ...
      this.titleBar.style.backgroundColor = '#cccccc';
   ...
   showExpanded: function() {
      //alert(this.titleBar.style.backgroundColor);
      this.expanded = true;
      this.titleBar.style.backgroundColor = this.accordion.options.expandedBg;
      this.titleBar.style.backgroundColor = '#eee';
      this.titleBar.style.color           = this.accordion.options.expandedTextColor;

      if(this.content.id != "panelSearchResult"){
      this.content.style.overflow         = "auto";
      }
      //alert(this.titleBar.id);
	  var tabs=document.getElementById("TabTable");
	  if(this.titleBar.id=="panel2Header") {
	  	  tabs.style.display="none";
	  }
	  else {
   ...
   hover: function(e) {
		...
		this.titleBar.style.backgroundColor = '#7a91c3';
