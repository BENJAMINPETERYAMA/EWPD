...
<f:view>
	...
	<TABLE width="100%" cellpadding="0" cellspacing="0">
		<h:inputHidden id="viewQuestionnaire"
			value="#{adminOptionQuestionnaireBackingBean.viewQuestionnaire}"></h:inputHidden>
		<tr>
			<td>&nbsp;</td>
		</tr>
		<tr>
						...
						<TABLE id="questionHeaderTable" cellspacing="1" cellpadding="3"
							...
							<TBODY>
								<TR>
									...
									[Reference]</strong></TD>
									<TD align="left" width="10%"><strong>Line of
									Business</strong></TD>
									<TD align="left" width="10%"><strong>Business
									Entity </strong></TD>
									<TD align="left" width="10%""><strong>Business
									Group</strong></TD>
									<TD align="left" width="10%""><strong>Market Business
									Unit</strong></TD>
								</TR>
