...
<f:view>
	...
	<hx:scriptCollector id="scriptCollector1">
		<TABLE width="100%" cellpadding="0" cellspacing="0">
			<h:inputHidden id="viewQuestionnaire" value="#{adminOptionQuestionnaireBackingBean.viewQuestionnaire}"></h:inputHidden>
			<TR>
									...
									<TABLE id="questionHeaderTable" cellspacing="1"
										...
										<TBODY>
											<TR>
												...
												<TD bgcolor="#cccccc" align="left" width="10%""><strong>Business
												Group</strong></TD>
												<TD bgcolor="#cccccc" align="left" width="10%""><strong>Market Business
												Unit</strong></TD>
											</TR>
...
if(document.getElementById('questionnaireView:associatedQuestionTable') != null) {
	...
	{
		setColumnWidth('questionHeaderTable','60%:10%:10%:10%:10%');
		setColumnWidth('questionnaireView:associatedQuestionTable','60%:10%:10%:10%:10%');
...
<form name="printForm"><input id="currentPrintPage" type="hidden"
	name="currentPrintPage" value="benefitAdminOptionQuestionnaire" /></form>
