				...
				<TR><TD>
						  <FIELDSET style="margin-left:2px;margin-right:-10px;padding-bottom:1px;padding-top:1px;width:99.5%">
                                <h:outputText id="breadcrumb" 
                                      value="#{benefitMandateBackingBean.printBreadCrumbText}">
                                </h:outputText>
</FIELDSET>
                          
						</TD></TR>
		<tr><td style="outputText" width="40%" align="left"><br>
						<br>
						&nbsp;&nbsp;&nbsp; <h:outputText
							value="Mandate Information" styleClass="outputText" />
						</td>
		</tr>
		<TR>
			<TD>
				<h:form styleClass="form" id="benefitMandatePrintForm">
				<h:inputHidden id="printBenefitMandate"
					value="#{benefitMandateBackingBean.printBenefitMandate}" />
					<TABLE border="0" cellspacing="1" cellpadding="3" class="outputText"
					width="100%">
						<TR>
							<TD colspan=3>
...
<script language="JavaScript">
	...
	formatTildaToCommaForStateCode("benefitMandatePrintForm:txtState");
