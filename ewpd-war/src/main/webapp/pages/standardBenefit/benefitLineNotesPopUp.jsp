...
<f:view>
	...
	<h:inputHidden id="notesList" value="#{benefitLevelNotesAttachmentBackingBean.notesList}"></h:inputHidden>
		<h:outputText value="No Notes Available." 
					rendered="#{benefitLevelNotesAttachmentBackingBean.availableNotes == null}" 
		...
		<DIV id="notesDiv">
			...
			<table width="98%" align="right" cellpadding="0" cellspacing="0"
				...
				<TBODY>
					...
					<tr>
						<td>
						<DIV id="popupDataTableDiv" style="height: 253px; overflow:auto;">
						<h:dataTable cellspacing="1" id="notesDataTable" 
							rendered="#{benefitLevelNotesAttachmentBackingBean.availableNotes != null}"
							value="#{benefitLevelNotesAttachmentBackingBean.availableNotes}"
