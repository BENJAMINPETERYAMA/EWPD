...
<TITLE>Product Structure General Information</TITLE>
<%
...
<!-- CARS END -->
									...
									<TR valign="top">
										<TD width="137">&nbsp;&nbsp;<h:outputText value="Name" /></TD>
										<TD width="237"><h:outputText id="structureName"
									...
									<TR>
										<TD width="137">&nbsp;&nbsp;<h:outputText value="Product Family" /></TD>	
										<TD width="237"><h:outputText id="productFamilyForView"
									...
									<TR>
										<TD width="137">&nbsp;&nbsp;<h:outputText value="Structure Type" /></TD>
										<TD width="237"><h:outputText id="strType"
									...
									<tr id="sub1" style="display:none;">
										<TD width="137"><h:outputText value="Mandate Type" /></TD>
										<TD width="237"><h:inputTextarea
									...
									<tr id="sub2" style="display:none;">
										<TD width="137"><h:outputText value="Jurisdiction" /></TD>
										<TD width="237"><h:inputTextarea
									...
									<tr id="sub3" style="display:none;">
										<TD width="137"><h:outputText value="Jurisdiction" /></TD>
										<TD width="237"><h:outputText id="stateFed" value="ALL" /></TD>
									</TR>
									
									<TR>
										<TD valign="top" width="137">&nbsp;&nbsp;<h:outputText value="Description" /></TD>
										<TD width="237"><h:outputText id="structureDesc"
											styleClass="formTxtAreaReadOnly" style="border:none;width:250px;"
											value="#{productStructureGeneralInfoBackingBean.description}">
										</h:outputText></TD>
									</TR>
                                    <TR>
										<TD width="137">&nbsp;&nbsp;<h:outputText value="Effective Date " /></TD>
										<TD width="237"><h:outputText id="effectiveDate"
									...
									<TR>
										<TD width="137">&nbsp;&nbsp;<h:outputText value="Expiry Date " /></TD>
										<TD width="237"><h:outputText id="expiryDate"
									...
									<TR>
										<TD width="137">&nbsp;&nbsp;<h:outputText value="Created By" /></TD>
										<TD width="237"><h:outputText id="createdUser"
									...
									<TR>
										<TD width="137">&nbsp;&nbsp;<h:outputText value="Created Date" /></TD>
										<TD width="237"><h:outputText id="creationDate"
									...
									<TR>
										<TD width="137">&nbsp;&nbsp;<h:outputText value="Last Updated By" /></TD>
										<TD width="237"><h:outputText id="lastUpdatedUser"
									...
									<TR>
										<TD width="137">&nbsp;&nbsp;<h:outputText value="Last Updated Date" /></TD>
										<TD width="237"><h:outputText id="lastUpdatedDate"
