...
<TITLE>Product Structure Hierarchy Print</TITLE>
<%
				...
				<TABLE width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<TR>
						...
						<div id="panel2Header" class="tabTitleBar"
							style="position:relative;width:100% "><STRONG>General Information
						</STRONG></div>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				<h:inputHidden id="getHierarchy"
					value="#{productStructureBenefitComponentBackingBean.componentHierarchy}"></h:inputHidden>
			</tr>
			<tr>
				...
				<FIELDSET
							style="margin-left:2px;margin-right:-10px;padding-bottom:1px;padding-top:1px;width:90%">

				<div id="panel2Header" class="tabTitleBar"
					style="position:relative;width:100% "><strong> Components Hierarchy</strong></div>				
				<h:outputText value="No Benefit Components available."
					rendered="#{productStructureBenefitComponentBackingBean.hierarchyList == null}" />
				<table class="smallfont" id="resultsTable" width="100%"
					...
					<tr>
						...
						<TABLE id="headerTable" width="100%" border="0" cellpadding="2"
							...
							<tr class="dataTableOddRow">
								...
								<td><strong><h:outputText value="Benefit" /></strong></td>
							</tr>
						</TABLE>
						</div>
						</td>
					...
					<tr>
						...
						<div id="searchResultdataTableDiv" style="overflow: auto;"><h:dataTable
							...
							rendered="#{productStructureBenefitComponentBackingBean.hierarchyList != null}"
							value="#{productStructureBenefitComponentBackingBean.hierarchyList}"
							rowClasses="dataTableOddRow" var="singleValue" cellpadding="3"
							width="100%">
							<h:column>
								<strong><h:outputText id="id" style="font-weight:bold"
									value="#{singleValue.benefitCmpntDesc}" /></strong>
							</h:column>
							<h:column>
								<h:outputText id="name"
									value="#{singleValue.standardBenefitDesc}"></h:outputText>
								<h:inputHidden id="benefitComponentName"
									value="#{singleValue.standardBenefitDesc}"></h:inputHidden>
							</h:column>
						</h:dataTable></div>
...
function initialize(){
	if(document.getElementById('productStructureGeneralInfoForm:bComponentDataTable') != null) {
		setColumnWidth('headerTable','25%:50%');
		setColumnWidth('productStructureGeneralInfoForm:bComponentDataTable','25%:50%');
	}else {
