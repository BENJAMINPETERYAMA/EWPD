...
<f:view>
	...
	<hx:scriptCollector id="scriptCollector1">
		<TABLE width="100%" cellpadding="0" cellspacing="0">
			<TR>
				<TD>	<h:inputHidden value="#{adminOptionBackingBean.loadProductStructureAdminOptions}"/>
				...
				<TD><h:form styleClass="form" id="adminOptionsForm">
					<TABLE width="100%" border="0" cellspacing="0" cellpadding="0">
						<TR>
							...
							<TD valign="top" class="leftPanel" width="305"><div class="treeDiv"><jsp:include
									...
									<TABLE width="200" border="0" cellspacing="0" cellpadding="0">
										<TR>
											...
											<TD class="tabNormal"><h:commandLink
												...
												action="#{adminMethodBackingBean.loadForProductStructureView}">
							...
							<!--	Start of Table for actual Data	-->
								<div id="adminDiv" ><h:outputText rendered="#{adminOptionBackingBean.adminOptionListForPrint == null}"
