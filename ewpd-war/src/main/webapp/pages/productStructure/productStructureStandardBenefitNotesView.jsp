					...
					<TABLE width="100%" border="0" cellspacing="0" cellpadding="0">
						<TR>
							<TD width="273" valign="top" class="leftPanel"><jsp:include
								page="productStructureTree.jsp"></jsp:include></TD>
							...
							<div id="emptymsg">
							<center><h:outputText value="No Notes Available."
								styleClass="dataTableColumnHeader" /></center>
							</div>
								...
								<TR>
									...
									<!-- Search Result Data Table --> <h:dataTable
										...
										<h:column>
											...
											<h:commandButton alt="View" id="viewButton" rendered="#{productStructureGeneralInfoBackingBean.securityAccess}"
