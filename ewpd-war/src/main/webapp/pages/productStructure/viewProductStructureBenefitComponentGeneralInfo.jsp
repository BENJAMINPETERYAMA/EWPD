...
<TITLE>View Product Structure Benefit Component General Info</TITLE>
<%
								...
								<table width="200" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<TD width="3" align="left"><IMG
											...
											width="3" height="21"></TD>
										<TD width="100%" class="tabNormal"><h:commandLink
											action="#{productStructureGeneralInfoBackingBean.loadNotesView}">
						...
						<TABLE border="0" cellspacing="0" cellpadding="3"
							...
							<TBODY>
								...
								<TR>
									...
									<TD width="335"><h:outputText id="name"
								...
								<TR>
									...
									<TD width="335"><h:outputText id="compType"
								...
								<tr id="sub1" style="display:none;">
									...
									<TD width="335"><h:outputText id="mandType"
								...
								<tr id="sub2" style="display:none;">
									...
									<TD width="335"><h:outputText id="state"
								...
								<tr id="sub3" style="display:none;">
									<TD width="3"></TD>
									<TD width="135"><h:outputText value="Jurisdiction" /></TD>
									<TD width="335"><h:outputText id="stateFed" value="ALL" /></TD>
								</TR>
								<TR>
									<TD width="3"></TD>
									<TD width="135" valign="top"><h:outputText value="Description" /></TD>
									<TD width="335"><h:outputText id="desc"
										value="#{productStructureGeneralInfoBackingBean.description}" styleClass="formTxtAreaReadOnly"/> <h:inputHidden
										id="descHidden"
								...
								<TR>
									...
									<TD width="335"><h:outputText id="expiryDate"
								...
								<TR>
									...
									<TD width="335"><h:outputText id="bnftCmpntVersion"
								...
								<TR>
									...
									<TD width="335"><h:outputText id="createdUser"
								...
								<TR>
									...
									<TD width="335"><h:outputText id="creationDate"
								...
								<TR>
									...
									<TD width="335"><h:outputText id="lastUpdatedUser"
								...
								<TR>
									...
									<TD width="335"><h:outputText id="lastUpdatedDate"
...
displayMandateTab();
	...
	var benType = document.getElementById("productStructureBenefitCompForm:compType");
...
function viewAction(){			
	...
	var benefitComponentName = document.getElementById('productStructureBenefitCompForm:nameHidden').value;
	//ICD10 End
