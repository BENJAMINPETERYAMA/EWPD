...
<f:view>
<body onkeydown="return submitOnEnterKey('TSCreatForm:create');">
			...
			<table border="0" cellspacing="0" cellpadding="3">
				...
				<tr>
					...
					<td colspan="2" valign="top">
						<h:inputHidden value="#{testSuiteBackingBean.testSuiteId}"></h:inputHidden>
						<h:inputText  styleClass="formInputField" value="#{testSuiteBackingBean.testSuiteName}"  onkeyup="return ismaxlength(this,70);"/>
					</td>
				</tr>
				<tr>
					...
					<td colspan="3" valign="top">
						<h:inputTextarea id="testSuiteDesc" styleClass="formTxtAreaField_GeneralDesc" value="#{testSuiteBackingBean.testSuiteDesc}" cols="37" rows="7"
										   onkeypress="return validateText();" onblur="return validateTestSuiteDesc();" />
...
<script language="JavaScript">
	...
	function validateText(){
		if(document.getElementById('TSCreatForm:testSuiteDesc').value.length > 299){
			return false;
		}else{
			return true;
		}
