...
<f:view>
	...
	<h:inputHidden value="#{testCaseBackingBean.expectedBenefitList}"></h:inputHidden>
		...
		<td>
		  ...
		  <table width="100%" cellpadding="0" cellspacing="1" bgcolor="#cccccc">
			<tr>
			  ...
			  <td width="90%"><strong>Benefit</strong></td>
			 </tr>
		  </table>
		  <DIV id="popupDataTableDiv"  style="overflow:auto;height: 367px;" class="popupDataTableDiv">
		  <h:dataTable id="benefitTable" width="100%" cellpadding="0" cellspacing="1" bgcolor="#cccccc" 
					   rowClasses="dataTableEvenRow,dataTableOddRow"
					   value="#{testCaseBackingBean.expectedBenefitList}" var="benefit" columnClasses="singleRowSelectColumn,descriptionColumn">
			<h:column>
			...
			<h:column>
				...
				<h:inputHidden value="#{benefit.benefitSysId}"></h:inputHidden>
				<h:inputHidden value="#{benefit.benefitName}"></h:inputHidden>
				<h:outputText value="#{benefit.benefitName}"></h:outputText>
			</h:column>
		  </h:dataTable>
		  </DIV>
		</td>
