...
<BODY  onunload="changeParentImage()">
	...
	<div id="noNotes">
		<h:outputText value="No Notes Available." 
					rendered="#{notesAttachmentBackingBean.questionNotes == null}" 
					styleClass="dataTableColumnHeader"/>
	</div>
	<h:inputHidden id="records" value="#{notesAttachmentBackingBean.records}"></h:inputHidden> 
		...
		<table width="98%" align="right" cellpadding="0" cellspacing="0" border="0">
								...
								<table width="100%" border="0" cellspacing="1" cellpadding="0"
									...
									<TR height="20">
										...
										<TD width="60%"><h:inputText styleClass="formInputField"
													id="txtSearch" value="#{notesAttachmentBackingBean.searchString}"
						...
						<td>
							<DIV id="popupDataTableDiv"  style="overflow:auto;" class="popupDataTableDiv">
									<h:dataTable id="notesDataTable"
										rowClasses="dataTableEvenRow,dataTableOddRow" columnClasses="selectOrOptionColumn,shortDescriptionColumn,longDescriptionColumn,selectOrOptionColumn"
										 cellspacing="1" width="100%" 
										value="#{notesAttachmentBackingBean.questionNotes}"
										var="singleValue" rendered="#{notesAttachmentBackingBean.questionNotes!=null}" cellpadding="0" bgcolor="#cccccc">
			...
			<h:inputHidden id ="questionId"  value ="#{notesAttachmentBackingBean.questionId}"></h:inputHidden>
			<h:inputHidden id ="primaryentityId"  value ="#{notesAttachmentBackingBean.primaryEntityID}"></h:inputHidden>
			<h:inputHidden id ="primaryEntytyType"  value ="#{notesAttachmentBackingBean.primaryType}"></h:inputHidden>
			<h:inputHidden id ="benefitComponentId"  value ="#{notesAttachmentBackingBean.benefitComponentId}"></h:inputHidden>
			<h:inputHidden id ="benefitDefnId"  value ="#{notesAttachmentBackingBean.benefitDefnId}"></h:inputHidden>
			<h:inputHidden id ="adminLvlOptionId"  value ="#{notesAttachmentBackingBean.adminLvlOptionAssnSysId}"></h:inputHidden>
			<h:inputHidden id ="prevVersionId"  value ="#{notesAttachmentBackingBean.previousNoteVersion}"></h:inputHidden>
			<h:inputHidden id ="notepresentId"  value ="#{notesAttachmentBackingBean.noteAttached}"></h:inputHidden>
	...
	<h:inputHidden id="prevNoteIdSelectedId" value="#{notesAttachmentBackingBean.prevNoteIdSelected}"></h:inputHidden>

	<h:inputHidden id="newNoteId" value="#{notesAttachmentBackingBean.newNoteIdSelected}"></h:inputHidden>
	<h:inputHidden id ="questionToProcessId"  value ="#{notesAttachmentBackingBean.questionId}"></h:inputHidden>
	<h:inputHidden id ="noteAction"  value ="#{notesAttachmentBackingBean.noteAction}"></h:inputHidden>
	<h:inputHidden id ="versionId"  value ="#{notesAttachmentBackingBean.noteVersion}"></h:inputHidden>
	<h:commandLink id="saveLink"
						style="display:none; visibility: hidden;"
						action="#{notesAttachmentBackingBean.saveAction}">
					</h:commandLink>
...
ajaxCall1('../popups/ajaxHelperQuestionNoteTable.jsp?&questionId='+questionId+
		...
		if((null== prevNote || ('')== prevNote)&& (null== noteIId||noteIId=='undefined'||('')== noteIId)){
			...
			return false;
				...
				if(null!= noteIId && null!= prevNote &&('')!= noteIId && ('')!= prevNote){
					...
					//document.getElementById('notesLookUpForm:notepresentId').value='Y';
					if(updateValue=='Y'){			
					...
					if(InsertValue=='Y'){
						...
						//document.getElementById('notesLookUpForm:notepresentId').value='N';
					if(deleteValue=='Y'){
