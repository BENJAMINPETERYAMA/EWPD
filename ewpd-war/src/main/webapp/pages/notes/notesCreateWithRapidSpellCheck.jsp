							...
							<TABLE border="0" cellspacing="0" cellpadding="3" class="outputText">
								<TBODY>
									...
									<TR>
										...
										<TD width="221"><h:selectOneMenu
											id="mandateTypeName" styleClass="formInputFieldForNotes"
											tabindex="2" value="#{notesBackingBean.type}">
		...
		//]]>
									...
									<TR>
										...
										<TD colspan="2" valign="top"><h:inputTextarea
											...
											tabindex="4" value="#{notesBackingBean.text}" onkeypress="return validateText();"/><RapidSpellWeb:rapidSpellWebLauncher 
						textComponentName="notesCreateForm:txtText" 
						mode="popup" 
						rapidSpellWebPage="CustomSpellCheckerPopUp.jsp"
						windowWidth="530"
						windowHeight="250"
						buttonImageMouseOut = "../../images/newspellcheck.jpg"
						textComponentInterface="Custom"
					/></TD>
									</TR>
									<TR>
										<TD width="139">&nbsp;<h:commandButton value="Create"
											styleClass="wpdButton"
											action="#{notesBackingBean.createNote}" tabindex="5">
										</h:commandButton></TD>
