...
<f:view>
	...
	<h:form styleClass="form" id="notesPrintForm">
		<TABLE width="100%" cellpadding="0" cellspacing="0">
			...
			<TR>
				<TD>
					<FIELDSET style="margin-left:92px;margin-right:-1px;padding-bottom:1px;padding-top:1px;width:89%">
		...
		<h:inputHidden id="typeList"
				...
				<h:inputHidden id="viewNotesKey"
					value="#{notesBackingBean.viewNotesKey}" /> <h:inputHidden
					id="noteID" value="#{notesBackingBean.noteId}"></h:inputHidden>
		<table width="80%" align="center" border="0" cellspacing="0"
				...
				<TABLE border="0" width="80%" cellspacing="0" cellpadding="3">
					<TBODY>
						<TR>
							...
							<TD width="60%"><h:outputText value="#{notesBackingBean.noteId}" />
							</TD>
						</TR>
						<TR>
							<TD width="40%"><h:outputText value="Note Name" /></TD>
							<TD width="60%"><h:outputText value="#{notesBackingBean.name}" />
							</TD>
						</TR>
						<TR>
						...
						<TR>
							...
							<TD width="60%"><h:outputText id="systemDomainDiv"
								value="#{notesBackingBean.systemDomain}" /> 
							</TD>
						</TR>
						<TR>
							<TD width="40%" valign="top"><h:outputText value="Note Text" /></TD>
							<TD width="60%" colspan="2"><h:outputText
								id="description_txtarea" value="#{notesBackingBean.formattedNotes}" />
						</TR>
						<TR>
			...
			<TR>
				...
				<div id="notesDataDomain"><h:inputHidden
					...
					value="#{notesBackingBean.loadDataDomainForPrint}"></h:inputHidden>
							...
							<TABLE width="100%" cellpadding="0" cellspacing="0" border="0">
								...
								<tr>
									...
									<h:dataTable  columnClasses="selectsystemDomainIdColumn"
										...
										id="productTable" value="#{notesBackingBean.productList}"
										var="eachRow" cellpadding="0">
										<h:column>
							...
							<TABLE width="100%" cellpadding="0" cellspacing="0" border="0">
								...
								<tr>
									...
									<h:dataTable  columnClasses="selectsystemDomainIdColumn1"
										...
										id="benfcompTable" value="#{notesBackingBean.componentList}"
										var="eachRow" cellpadding="0">
										<h:column>
						...
						<TR>
							...
							<TABLE width="100%" cellpadding="0" cellspacing="0" border="0">
								...
								<tr>
									...
									<h:dataTable  columnClasses="selectsystemDomainIdColumn1"
										cellspacing="1"
										rendered="#{notesBackingBean.benefitList!= null}" width="100%"
										id="benfTable" value="#{notesBackingBean.benefitList}"
										var="eachRow" cellpadding="0">
										<h:column>
						...
						<TR>
							...
							<TABLE width="100%" cellpadding="0" cellspacing="0" border="0">
								...
								<tr>
									...
									<h:dataTable  columnClasses="selectsystemDomainIdColumn1"
										cellspacing="1"
										rendered="#{notesBackingBean.questionList!= null}" width="100%"
										id="questTable" value="#{notesBackingBean.questionList}"
										var="eachRow" cellpadding="0"> 
										<h:column>
							...
							<TABLE width="100%" cellpadding="0" cellspacing="0" border="0">
								...
								<tr>
									...
									<h:dataTable  columnClasses="selectsystemDomainIdColumn1"
										...
										value="#{notesBackingBean.termList}"
										rendered="#{notesBackingBean.termList!= null}" var="eachRow"
										cellpadding="0">
										<h:column>
							...
							<TABLE cellpadding="0" cellspacing="0" border="0" width="100%">
								...
								<tr>
									...
									<h:dataTable  columnClasses="selectsystemDomainIdColumn1"
										...
										value="#{notesBackingBean.qualifierList}"
			...
			<fieldset>
				<table border="0" width="80%" cellspacing="0" cellpadding="3">
					<TR>
						...
						<TD width="60%"><h:outputText value="#{notesBackingBean.state}" />
						</TD>
					</TR>

					<TR>
						<TD width="40%"><h:outputText value="Status" /></TD>
						<TD width="60%"><h:outputText value="#{notesBackingBean.status}" />
						</TD>
					</TR>

					<TR>
						<TD width="40%"><h:outputText value="Version" /></TD>
						<TD width="60%"><h:outputText value="#{notesBackingBean.version}" />
						</TD>
					</TR>
				</table>
				</fieldset>
...
document.getElementById('messageDiv').style.visibility = 'hidden';
	...
	hideIfNoValue('CompHeaderDiv', 'benfTable');
	hideIfNoValue('BenefitHeaderDiv','benfcompTable');
...
function formatTildaToComma(objName)
{
	...
	var printForGenInfo = document.getElementById("notesPrintForm:printNotesGeneralInformation").value;
	var printForDataDom = document.getElementById("notesPrintForm:printNotesDataDomain").value;
	if("" == printForGenInfo){
	...
	if( null == printForGenInfo || "" == printForGenInfo ){
		...
		if(document.getElementById('notesPrintForm:productTable') == null &&
			...
			document.getElementById('notesPrintForm:questTable') == null &&
