			...
			<TBODY>
					...
					<table width="100%" border="0" cellspacing="1" cellpadding="0"
						...
						<tr>
							...
							<TD width="94%" align="center"><strong> <h:outputText
								value="Admin Options" styleClass="outputText"></h:outputText></strong></td>
						</tr>
					</table>
					</TD>
				</TR>
				...
				<tr>
					...
					<div id="searchResultdataTableDiv" 
					    style="height:340px;width:100%;overflow-y: auto; "><h:dataTable id="adminDataTable"
						value="#{productAdminPopupBackingBean.productAdminList}" width="100%"
						var="eachRow" cellpadding="1" cellspacing="1" bgcolor="#cccccc"
						columnClasses="selectOrOptionColumn,selectOrOptionColumn1"
						rendered="#{productAdminPopupBackingBean.productAdminList != null}"
...
<script>
setColumnWidth('adminForm:adminDataTable','6%:100%');
	...
	if(hiddenObj.value) {
	 ...
	 matchCheckboxItems_ewpd('adminForm:adminDataTable', window.dialogArguments.selectedValues, 2, 2, 2);
	}
</script>
