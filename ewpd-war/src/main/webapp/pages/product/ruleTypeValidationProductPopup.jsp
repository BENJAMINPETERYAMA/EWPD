...
<f:view>
	...
	<h:form styleClass="form" id="formName">
		...
		<table id="questionHeaderTable" width="98%" cellpadding="1"
			...
			<tr>
				<td width="15%"><h:outputText value="Product Name " /></td>
		...
		<!-- Search Result Data Table --> <h:dataTable styleClass="outputText"
			...
			<h:column>
				<h:outputText id="dateSegmentId" value="#{singleValue.benefitComponentName}"></h:outputText>
			</h:column>
			<h:column>
				<h:outputText id="productName3" value="#{singleValue.benefitName}"></h:outputText>
			</h:column>
			<h:column>
...
if(tablesize == 0)
{
	...
	setColumnWidth('formName:searchResultTable','13%:16%:17%:19%:22%');
	setColumnWidth('resultHeaderTable','13%:16%:17%:19%:22%');
...
<form name="printForm"><input id="currentPrintPage" type="hidden"
	name="currentPrintPage" value="ruleTypeProductValidation" /></form>
</HTML>
