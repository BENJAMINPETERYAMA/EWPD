...
<h:inputHidden id="printproductBenefitDefinition"
			value="#{productBenefitDetailBackingBean.loadDuplicateReference}"></h:inputHidden>
<table width = '100%'>
	<tr>
		<td align="right">
			<a href="#">
		...
		<table id="questionHeaderTable" width="98%"  cellpadding="1" cellspacing="1" border="0" align="center">
			<tr>
				...
				<td >
					<h:outputText value="#{productBenefitDetailBackingBean.productName}" id="productName"/>
				</td>
				<td width="25%">
			...
			<tr>
				...
				<td>
					<h:outputText value="#{productBenefitDetailBackingBean.productVersion}" id="versionNumber"/>
				</td>		
				<td>
				</td>
			</tr>			
								...
								<TABLE cellspacing="1" bgcolor="#cccccc" cellpadding="3"
									...
									<TR>
										<TD><strong><h:outputText value="Benefit Lines with duplicate Reference"></h:outputText></strong></TD>
									</TR>
								</TABLE>
								<TABLE cellspacing="1" bgcolor="#cccccc" cellpadding="3"
								...
								<!-- Search Result Data Table --> <h:dataTable
									...
									rendered="#{productBenefitDetailBackingBean.duplicateBenefitLineRefList != null}"
									value="#{productBenefitDetailBackingBean.duplicateBenefitLineRefList}"
									rowClasses="dataTableEvenRow" border="0">

									<h:column>
										<h:outputText id="benefitComponentName" value="#{singleValue.benefitComponentName}"></h:outputText>
									</h:column>
									<h:column>
										<h:outputText id="benefitSysName" value="#{singleValue.benefitSysName}"></h:outputText>
									</h:column>
									<h:column>
										<h:outputText id="referenceDesc" value="#{singleValue.referenceDesc}"></h:outputText>
									</h:column>
									<h:column>
										<h:outputText id="benefitLevelDesc" value="#{singleValue.benefitLevelDesc}"></h:outputText>
									</h:column>
									<h:column>
										<h:outputText id="benefitLinePva" value="#{singleValue.benefitLinePva}"></h:outputText>
									</h:column>								
								</h:dataTable>
						</DIV>
						...
						<TABLE width="100%" cellspacing="0" cellpadding="0">
							...
							<TR>
								...
								<!-- Search Result Data Table --> <h:dataTable
									...
									width="100%" cellspacing="1" bgcolor="#cccccc"
									rendered="#{productBenefitDetailBackingBean.duplicateQuestionRefList != null}"
									value="#{productBenefitDetailBackingBean.duplicateQuestionRefList}"
									rowClasses="dataTableEvenRow" border="0">

									<h:column>
										<h:outputText id="benefitComponentNameQuest" value="#{singleValue.benefitComponentName}"></h:outputText>
									</h:column>
									<h:column>
										<h:outputText id="benefitSysNameQuest" value="#{singleValue.benefitSysName}"></h:outputText>
									</h:column>
									<h:column>
										<h:outputText id="referenceDescQuest" value="#{singleValue.referenceDesc}"></h:outputText>
									</h:column>
									<h:column>
										<h:outputText id="adminDescQuest" value="#{singleValue.adminDesc}"></h:outputText>
									</h:column>
									<h:column>
...
<!-- Space for hidden fields -->
				<h:inputHidden id="timeId"
					value="#{productBenefitDetailBackingBean.totalTime}"></h:inputHidden>
</h:form>
	</BODY>
</f:view>
...
if(tablesize == 0)
{
	...
	setColumnWidth('formName:searchResultTable','25%:25%:25%:20%:5%');
	setColumnWidth('resultHeaderTable','25%:25%:25%:20%:5%');
...
for(var i=0;i<tablesizeQuest;i++)
{
	...
	var cellobjQuest = tableObjectQuest.rows[i].cells[2];
...
document.getElementById('searchResultdataTableQuestDiv').style.display = 'none';
	...
	setColumnWidth('formName:searchResultQuestTable','20%:20%:20%:20%:20%');
	setColumnWidth('resultQuestHeaderTable','20%:20%:20%:20%:20%');
...
<form name="printForm"><input id="currentPrintPage" type="hidden"
	name="currentPrintPage" value="productUniqueReferenceValidation" /></form>
</HTML>
