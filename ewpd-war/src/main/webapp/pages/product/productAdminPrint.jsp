...
<f:view>
	...
	<h:form styleClass="form" id="productAdministrationPrintForm">
...
<script>
	...
	function hideIfNoValue(divId){
		hiddenIdObj = document.getElementById('productAdministrationPrintForm:searchResultTable');		
		if(hiddenIdObj.rows.length == 0){
			...
			document.getElementById('emptymsg').style.visibility = 'hidden';
	 		setColumnWidth('productAdministrationPrintForm:searchResultTable','40%:30%:30%');
		}
	}	
</script>
<script>
