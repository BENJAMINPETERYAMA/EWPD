				...
				<TD>
					...
					<TABLE width="100%" border="0" cellspacing="0" cellpadding="0">
						<TR>
									...
									<TABLE width="200" border="0" cellspacing="0" cellpadding="0">
										<TR>
											...
											<TD class="tabNormal"><h:commandLink
												...
												action="#{adminMethodBackingBean.loadForProductView}">
							...
							<div id="adminDiv" align="left" ><h:outputText rendered="#{adminOptionBackingBean.adminOptionList == null}"
							...
							<DIV id="searchResultdataTableDiv" >
								...
								<TR>
									...
									<!--<DIV id="searchResultdataTableDiv1"
									...
									<!-- Search Result Data Table --> <h:dataTable
										...
										value="#{adminOptionBackingBean.adminOptionListForPrint }" cellpadding="3"
										width="100%" cellspacing="1" bgcolor="#cccccc" rendered="#{adminOptionBackingBean.adminOptionListForPrint  != null}"
