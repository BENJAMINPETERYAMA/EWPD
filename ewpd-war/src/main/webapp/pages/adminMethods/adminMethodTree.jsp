...
<f:subview id="tree2">
	...
	<h:inputHidden id="scrollTop" value="#{adminmethodTreeBackingBean.scrollTop}" />
	<aa:zoneJSF id="treeZone">
		<jcaa:ajaxTree id="serverTree" value="#{adminmethodTreeBackingBean.treeDataModel}"
...
<f:facet name="Benefit-Component">
		...
		<f:facet name="Standard-Benefit">
			<h:panelGroup>
				<h:commandLink styleClass="#{t.nodeSelected ? 'treeNodeLinkSelected':'treeNodeLink'}"
					actionListener="#{adminmethodTreeBackingBean.processActionForBenefit}" action ="#{adminMethodBackingBean.loadForProductValidation}"
	...
	<h:inputHidden id="hasValErrors"
					value="#{adminmethodTreeBackingBean.withChildren}"></h:inputHidden>
</f:subview>
