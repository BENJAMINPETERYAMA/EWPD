...
<f:view>
	...
	<hx:scriptCollector id="scriptCollector1">
		<TABLE width="100%" cellpadding="0" cellspacing="0">
			<TR>
				<h:inputHidden id="breadcrumb" value="#{adminMethodBackingBean.breadCrumbText}"></h:inputHidden>
					...
					<TABLE width="100%" border="0" cellspacing="0" cellpadding="0">
						<TR>
							...
							<TD width="273" valign="top" class="leftPanel">
								...
								<div class="treeDiv">								
									<jsp:include
										page="../adminMethods/adminMethodTree.jsp"></jsp:include>
								</div>
							...
							<TR>
						      ...
						      <DIV id="panelContent" style="position:relative;background-color:#FFFFFF;">
                               <h:panelGroup id="associatedpanel" style="width:100%;" styleClass="dataTableColumnHeader">
 							    ...
 							    <h:panelGrid id="panelTable" binding="#{adminMethodBackingBean.panelForValidation}" rowClasses="dataTableOddRow,dataTableEvenRow">
							    </h:panelGrid>
							   </h:panelGroup> 
							  </DIV>
								<br>											
...
<form name="printForm">
<input id="currentPrintPage" type="hidden" name="currentPrintPage" value="adminMethodValidation" />
</form>
