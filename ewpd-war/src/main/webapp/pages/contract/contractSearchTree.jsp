...
<f:subview id="tree2">
	...
	<h:inputHidden id="scrollTop" value="#{contractSearchTreeBackingBean.scrollTop}" />
	<aa:zoneJSF id="treeZone">
		<jcaa:ajaxTree id="serverTree" value="#{contractSearchTreeBackingBean.treeDataModel}"
		...
		<f:facet name="Standard-Benefit">
			...
			actionListener="#{contractSearchTreeBackingBean.processActionForStandardBenefit}" action ="#{contractSearchTreeBackingBean.refresh}"
