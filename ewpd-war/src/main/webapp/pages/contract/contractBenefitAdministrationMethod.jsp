...
<!--  WAS 7.0 Changes - Hidden id rootQuestionLoad value loaded using binding instead of value -->
			<TR><h:inputHidden id="pageLoad" binding="#{adminMethodBackingBean.valuesFromSessionForContract}"></h:inputHidden>
...
<jsp:include
							...
							<h:inputHidden id="duplicateData" value="#{adminMethodBackingBean.duplicateData}"></h:inputHidden>
...
<FIELDSET	style="margin-left:6px;margin-right:-6px;padding-bottom:1px;padding-top:6px;width:100%">							
		   ...
		   <table width="100%" cellspacing="0" cellpadding="0">
			<TR>
			  <td align="right"> 
				<a id="viewAll" href="#" onclick="viewAllAdminmethod();return false;">
 				 <h:outputText	value="[View all Admin methods]" styleClass="variableLink" /></a>
 			  </td>
			</tr>
			<tr>
						...
						<TABLE class="smallfont" id="resultsTable" width="100%" cellpadding="0" cellspacing="0" border="0" bordercolor="red">							
						  ...
						  <TD class="ContentArea" align="left" valign="top" width="100%">
						   <TABLE width="100%" cellpadding="0" align="left" border="0" id="tabheader" >															
							...
							<TR>
							 <TD>
							  <SPAN style="margin-left:14px;margin-right:6px;">
							   <h:commandButton rendered = "#{adminMethodBackingBean.typeFlag}" value="Save" onmousedown="javascript:savePageAction(this.id);"	styleClass="wpdButton" id="saveButton"	action="#{adminMethodBackingBean.saveAdminMethodsForContract}">
							   </h:commandButton>
							 </SPAN>
							</TD>
						   </TR>
						   <h:inputHidden  id="states" value="#{adminMethodBackingBean.adminMethodState}">	</h:inputHidden>																			
						</TABLE>					
			           </TD>
			          </TR>
					 </TABLE>
...
function viewAllAdminmethod(){
	...
	IGNORED_FIELD1='adminMethodForm:duplicateData' 
		...
		setColumnWidth('adminMethodForm:displayTable', '30%:35%:35%');
