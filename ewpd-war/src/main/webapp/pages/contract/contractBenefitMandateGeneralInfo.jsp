...
<base target=_self>
<TITLE>ContractNonAdjBenefitMandatesView</TITLE>
<%
									...
									<tr>
										...
										<td width="200">
		          							<table width="200" border="0" cellspacing="0" cellpadding="0">
		              							<tr>
				                					<td width="2" align="left"><img src="../../images/tabNormalLeft.gif" alt="Tab Left Normal" width="3" height="21" /></td>
													<td width="186" class="tabNormal"> <h:commandLink action ="#{productBenefitDetailBackingBean.getBenefitDefinitionsPage}"> <h:outputText value="Notes"/> </h:commandLink> </td> 
				                					<td width="2" align="right"><img src="../../images/tabNormalRight.gif" alt="Tab Right Normal" width="2" height="21" /></td>
		              							</tr>
		          							</table>
		          						</td>
...
<!--	Start of Table for actual Data	-->		
					...
					<tr>
						...
						<h:dataTable
							...
							value="#{contractNonAdjBenefitMandateBackingBean.locateResultsList}"
