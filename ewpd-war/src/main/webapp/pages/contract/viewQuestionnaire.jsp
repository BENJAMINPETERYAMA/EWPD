...
<f:view>
	...
	<hx:scriptCollector id="scriptCollector1">
		<TABLE width="100%" cellpadding="0" cellspacing="0">
			<h:inputHidden id="viewQuestionnaire" value="#{adminOptionQuestionnaireBackingBean.viewContractQuestionnaire}"></h:inputHidden>
			<TR>
							...
							<TABLE id="associatedQuestionsTable" width="100%" cellpadding="0"
								...
								<TR>
									...
									<TABLE id="questionHeaderTable" cellspacing="1"
										...
										<TBODY>
											<TR>
												<TD bgcolor="#cccccc" align="left" ><strong>&nbsp;Question
												[Reference]</strong></TD>
												<TD align="left"><strong>Parent Required</strong></TD>
												<TD align="left"><strong>Functional Domain</strong></TD>
												<TD bgcolor="#cccccc" align="left"><strong>Line
												of Business</strong></TD>
												<TD bgcolor="#cccccc" align="left"><strong>Business
												Entity </strong></TD>
												<TD bgcolor="#cccccc" align="left"><strong>Business
												Group</strong></TD>
												<TD bgcolor="#cccccc" align="left"><strong>Market Business
												Unit</strong></TD>
											</TR>
...
if(document.getElementById('questionnaireView:associatedQuestionTable') != null) {
	...
	{
		setColumnWidth('questionHeaderTable','42%:6%:20%:8%:8%:8%:8%');
		setColumnWidth('questionnaireView:associatedQuestionTable','42%:6%:20%:8%:8%:8%:8%');
...
<form name="printForm"><input id="currentPrintPage" type="hidden"
	name="currentPrintPage" value="contractAdminOptionQuestionnaire" /></form>
