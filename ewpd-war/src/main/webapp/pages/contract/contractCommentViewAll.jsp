			...
			<TR>
				...
				<TD><h:form styleClass="form" id="ContractCommentForm">
					<TABLE width="100%" border="0" cellspacing="0" cellpadding="0">
						<TR>
							<TD valign="top" class="leftPanel" width="348"><!-- Space for Tree  Data	-->
							...
							<TABLE>
								<TBODY>
									<TR>
										<TD><w:message
											value="#{contractCommentBackingBean.validationMessages}"></w:message>
										</TD>
									</TR>
							...
							<TABLE border="0" cellspacing="0" cellpadding="3"
								...
								<tr>
									...
									<td><h:inputTextarea styleClass="formTxtAreaField3"
										id="txtNewComment"
										value="#{contractCommentBackingBean.newComments}" tabindex="5" onblur="return validateNoteText();"></h:inputTextarea><BR>
									</td>
								</tr>
								...
								<TR>
									<!-- <TD></TD>
									<TD></TD> -->
									<TD><h:commandButton styleClass="wpdbutton" value="Save" id="save"
										tabindex="9"
							...
							<TABLE id="resultHeaderTable1" width="100%"cellpadding="0"
								...
								<TR>
									<TD height="15"><b>&nbsp;<h:outputText value="Comments History"></h:outputText></b></TD>
								</TR>
							</TABLE>
							<TABLE cellspacing="1" bgcolor="#cccccc" cellpadding="3"
								id="resultHeaderTable" width="677px">
							...
							<DIV id="searchResultdataTableDiv"
								...
								<h:column>
									<h:commandButton alt="View" id="viewButton"
										...
										onclick="viewAction();window.showModalDialog('../contract/viewComment.jsp'+getUrl()+'?commentId='+commentId+'&dateSegmentId='+dateSegmentId+'&temp=' + Math.random(),'dummyDiv','dialogHeight:450px;dialogWidth:515px;resizable=false;status=no');return false;">
									</h:commandButton>
							...
							<table border="0" cellspacing="0" cellpadding="3" width="100%">
								<tr>
									<td align="left"><table Width=100%><tr><td></td><td></td></tr><tr><td><h:selectBooleanCheckbox id="checkall"
										value="#{contractCommentBackingBean.checkin}">
									...
									<TR><TD>&nbsp;&nbsp;</TD></TR>
                                     <TR>
										<TD>&nbsp;&nbsp;<h:commandButton styleClass="wpdbutton" value="Done"
											tabindex="15" onclick="return done();">
										</h:commandButton></TD>
...
<h:inputHidden id="temp"
					value="#{contractCommentBackingBean.tempVal}"></h:inputHidden>
...
var commentId;
var dateSegmentId;
//var tableSize = document.getElementById('ContractCommentForm:resultsTable');
//alert("tableObject"+tableSize);
	function syncTables(){
...
//	if(document.getElementById('ContractCommentForm:resultsTable') != null){
//		document.getElementById('ContractCommentForm:resultsTable').onresize = syncTables;
//		syncTables();
//	}
...
if(document.getElementById('ContractCommentForm:hasValErrors').value == 'true'){
	var url='../adminMethods/adminMethodValidationView.jsp'+getUrl()+'?temp='+Math.random();
