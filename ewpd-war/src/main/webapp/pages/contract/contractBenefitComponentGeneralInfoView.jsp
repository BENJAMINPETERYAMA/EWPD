...
<%-- jsf:pagecode language="java" location="/JavaSource/pagecode/pages/contract/ContractBenefitComponentGeneralInfoView.java" --%><%-- /jsf:pagecode --%>
<HTML>
<HEAD>
...
<TITLE>Product Benefit Component General Info View</TITLE>
<%
						...
						<TABLE border="0" cellspacing="0" cellpadding="3"
							...
							<TBODY>
								...
								<TR>
									...
									<TD width="239"><h:outputText id="txtDescription"
										value="#{contractComponentGeneralInfoBackingBean.description}" styleClass="formTxtAreaReadOnly"></h:outputText> 
										<h:inputHidden id="descHid"
                                ...
                                <TR>
									...
									<TD width="239"><h:outputText
										...
										id="effDate" /> <h:inputHidden id="effDateHid"
								...
								<TR>
									...
									<h:inputHidden id="expiryDateHid"
								...
								<TR>
									...
									<h:inputHidden id="createdUserHid"
								...
								<TR>
									...
									<h:inputHidden id="creationDateHid"
										value="#{contractComponentGeneralInfoBackingBean.createdDate}">
										<f:convertDateTime pattern="MM/dd/yyyy HH:mm:ss" />
								...
								<TR>
									...
									<h:inputHidden id="lastUpdatedUserHid"
								...
								<TR>
									...
									<h:inputHidden id="lastUpdatedDateHid"
										value="#{contractComponentGeneralInfoBackingBean.lastUpdatedDate}">
										<f:convertDateTime pattern="MM/dd/yyyy HH:mm:ss" />
									</h:inputHidden></TD>
								</TR>
...
<script>
	...
	copyHiddenToDiv_ewpd('contractBenefitComponentForm:marketBusinessUnitHidden','marketBusinessUnitDiv',2,2);
...
function viewAction(){
	...
	var benefitComponentName = document.getElementById('contractBenefitComponentForm:nameHid').value;
	//ICD10 End
