...
<TITLE>ContractBenefitMandateInformationView</TITLE>
<%
					          			...
					          			<td width="200">
		          							<table width="200" border="0" cellspacing="0" cellpadding="0">
		              							<tr>
													...
													<td width="186" class="tabNormal"><h:commandLink action ="#{contractBenefitGeneralInfoBackingBean.displayStandardBenefitGeneralInfo}"> <h:outputText value="General Information"/> </h:commandLink></td> 
										...
										<td width="200">
		          							<table width="200" border="0" cellspacing="0" cellpadding="0">
												<tr>
													...
													<td class="tabNormal"> 
														<h:commandLink action = "#{contractCoverageBackingBean.getCoverage}"> <h:outputText value="Mandate Definition"/> </h:commandLink> 
													</td>
...
<!--	Start of Table for actual Data	-->		
									...
									<table cellspacing="0" cellpadding="0" border="0" width="100%">
										<tr>
											...
											<h:inputHidden id="txtState"
												value="#{contractBenefitMndateInfoBacingBean.stateCode}"></h:inputHidden>
											</TD>											
										</tr>
									</table>
									</td>
									...
									<tr>
										...
										<td width="42%"><h:outputText value="#{contractBenefitMndateInfoBacingBean.mandateCategory}"></h:outputText>
										<h:inputHidden id="MandateCategoryHidden" value="#{contractBenefitMndateInfoBacingBean.mandateCategory}"></h:inputHidden>	
									</td>										
									...
									<TR>
										...
										<h:inputHidden id="CitationNumberHidden"
												value="#{contractBenefitMndateInfoBacingBean.citationNumber}"></h:inputHidden>										
										</TD>
									</TR>
									...
									<TR>
										...
										<h:inputHidden id="FundingArrangementHidden" value="#{contractBenefitMndateInfoBacingBean.fundingArrangement}"></h:inputHidden>
									...
									<TR>
										...
										<h:inputHidden id="EffectivenessHidden" value="#{contractBenefitMndateInfoBacingBean.effectiveness}"></h:inputHidden>
										</td>
									</TR>
									...
									<TD width="42%" valign="top"><h:inputTextarea
										 id="txtDescription" readonly="true"
										value="#{contractBenefitMndateInfoBacingBean.text}" ></h:inputTextarea>
									<h:inputHidden id="TextHidden" value="#{contractBenefitMndateInfoBacingBean.text}"></h:inputHidden>
									</TD>
...
<form name="printForm"><input id="currentPrintPage" type="hidden"
	name="currentPrintPage" value="benefitMandateInfo" /></form>
<script>
