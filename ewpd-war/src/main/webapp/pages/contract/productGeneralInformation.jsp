									...
									<TR>
										...
										<TABLE border="0" cellspacing="5" cellpadding="3">
											<TR>
												...
												<TD width="172"><%-- 
													<h:inputTextarea
													styleClass="formTxtAreaReadOnly" id="txtLineOfBusiness"
													value="#{contractProductGeneralInfoBackingBean.lineOfBusinessDiv}" tabindex="4"
...
<!-- ------------------------------------------------------------------------------------------------------------------ -->
									...
									<TR valign="top">
										...
										<TD width="184"><h:outputText id="productNametxt"
											value="#{contractProductGeneralInfoBackingBean.productName}" />
										<h:inputHidden
											value="#{contractProductGeneralInfoBackingBean.productName}"></h:inputHidden>
										</TD>
									...
									<TR valign="top">
										...
										<h:inputHidden
											value="#{contractProductGeneralInfoBackingBean.productFamilyDiv}"></h:inputHidden>
										</TD>
									</TR>
									<TR valign="top">
										<TD width="10"></TD>
										<TD width="122"><h:outputText id="productType"
											value="Product Type" styleClass="mandatoryNormal" /></TD>
										<TD width="184"><h:outputText id="productType_txt"
											value="#{contractProductGeneralInfoBackingBean.productType}" />
										<h:inputHidden
											value="#{contractProductGeneralInfoBackingBean.productType}"></h:inputHidden>
										</TD>
									</TR>
									...
									<TR valign="top">
										...
										<h:inputHidden
											value="#{contractProductGeneralInfoBackingBean.productStructDiv}"></h:inputHidden>
									...
									<TR valign="top">
										...
										<TD width="184"><h:inputTextarea
											...
											tabindex="4" readonly="true"></h:inputTextarea> <h:inputHidden
											value="#{contractProductGeneralInfoBackingBean.productDescription}"></h:inputHidden>
										<%--
											<h:inputHidden id="descriptionHidden" value="#{contractProductGeneralInfoBackingBean.productDescription}"></h:inputHidden>
												<div id="descriptionDiv" class="selectDataDisplayDiv" style="height:180px;width:170px;overflow:auto;"></div>
												<h:inputTextarea styleClass="formTxtAreaField_GeneralDesc" id="productDescription_txt" value="#{contractProductGeneralInfoBackingBean.productDescription}"></h:inputTextarea>
										--%></TD>
										<TD width="40"><f:verbatim></f:verbatim></TD>
									</TR>
                                    <TR valign="top">
										...
										<h:inputHidden
											value="#{contractProductGeneralInfoBackingBean.effectiveDate}"></h:inputHidden>
										</TD>
									</TR>
									<TR valign="top">
										<TD width="10"></TD>
										...
										<h:inputHidden
											value="#{contractProductGeneralInfoBackingBean.expiryDate}"></h:inputHidden>
										</TD>
									</TR>
									<TR valign="top">
										<TD width="10"></TD>
...
<script>
 ...
 copyHiddenToDiv_ewpd('productForm:marketBusinessUnitHidden','marketBusinessUnit',2,2); 
</script>
