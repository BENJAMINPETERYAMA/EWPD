...
<TITLE>WellPoint Product Database: Comments</TITLE>
<%
				...
				<TD><h:form styleClass="form" id="ContractCommentForm">
					<TABLE width="100%" border="0" cellspacing="0" cellpadding="0">
						<TR>
							...
							<h:dataTable headerClass="tableHeader_comments" id="resultsTable"
								border="0"
								value="#{contractCommentBackingBean.commentHistroyList}"
								rendered="#{contractCommentBackingBean.commentHistroyList != null}"
								var="eachRow" style="width: 100%;" cellpadding="3" cellspacing="1"
								...
								<h:column>
									<h:commandButton alt="View" id="viewButton"
										...
										onclick="viewAction();window.showModalDialog('viewComment.jsp'+getUrl()+'?commentId='+commentId+'&dateSegmentId='+dateSegmentId+'&temp=' + Math.random(),'dummyDiv','dialogHeight:450px;dialogWidth:515px;resizable=false;status=no');return false;">
									</h:commandButton>
	...
	function hideResultDiv() {
		...
		if(document.getElementById('ContractCommentForm:resultsTable') != null) {
			...
			var relTblWidth = document.getElementById('resultHeaderTable').offsetWidth;
				document.getElementById('ContractCommentForm:resultsTable').width = relTblWidth+"px";
