...
<f:view>
	...
	<h:inputHidden id="loadBCNotes" value="#{contractCoverageNotesOverrideBackingBean.loadNotes}"/> 
		<h:outputText value="No Notes Available." 
					rendered="#{contractCoverageNotesOverrideBackingBean.benefitComponentNoteObj == null}" 
				...
				<TBODY>
					...
					<tr>
						...
						<h:dataTable cellspacing="1" id="notesDataTable" 
							rendered="#{contractCoverageNotesOverrideBackingBean.benefitComponentNoteObj!= null}"
							value="#{contractCoverageNotesOverrideBackingBean.benefitComponentNoteObj}"
	...
	<h:inputHidden id="selectedNotesHidden" value= "#{contractCoverageNotesOverrideBackingBean.selectedNotes}"/> 
	<h:inputHidden id="hiddenLineId" value="#{contractCoverageNotesOverrideBackingBean.secEntityId}"></h:inputHidden>
	<h:inputHidden id="hiddenPrimaryEntityType" value="#{contractCoverageNotesOverrideBackingBean.primaryEntityType}"></h:inputHidden>
	<h:commandLink id="saveButton" action="#{contractCoverageNotesOverrideBackingBean.saveBenefitCompNotes}" style="display:none; visibility: hidden;"><f:verbatim> &nbsp;&nbsp;</f:verbatim></h:commandLink> 
	</h:form>
	</BODY>
</f:view>
...
/*function changeNoteImage(){
	...
	if(null != tableObject){
		...
		if(null != selectedNotes){
			notesArray = selectedNotes.split('~');
			if(notesArray != null && notesArray != '' && notesArray.length > 0)
