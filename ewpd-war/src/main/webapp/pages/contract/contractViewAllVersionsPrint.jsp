...
<TITLE>Print For Contract All Versions</TITLE>
</HEAD>
<f:view>
	<BODY>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td><FIELDSET style="margin-left:8px;margin-right:-30px;padding-bottom:1px;padding-top:1px;width:98%">
                        <h:outputText id="breadcrumb" 
                              value="#{contractSearchBackingBean.breadCrumbPrint}">
                        </h:outputText>
                   </FIELDSET>
				</td>
			</tr>
			<tr>
				<td colspan="2" valign="top" align="left" class="ContentArea"
					width="100%">
				<w:message></w:message>
				<div id="searchPanelHeader" class="tabTitleBar"><b>Available Versions</b></div>
				<br />
...
<SCRIPT>
	if(null != document.getElementById('viewAllVersionForm:previousVersionsTable')){
		setColumnWidth('resultHeaderTable','16%:10%:13%:24%:11%:13%:13%');
		setColumnWidth('viewAllVersionForm:previousVersionsTable','16%:10%:13%:24%:11%:13%:13%');
	}
window.print();
</SCRIPT>
</HTML>
