...
<f:view>
	...
	<h:form styleClass="form" id="benefitAdministrationDetailedPrintForm">
		...
		<TABLE width="100%" cellpadding="0" cellspacing="0" border="0" >
			<tr><td>&nbsp; </td></tr>
			<TR>
					<TD>  <FIELDSET style="margin-left:2px;margin-right:-10px;padding-bottom:1px;padding-top:1px;width:98.8%">
			...
			<TR>
				<TD>
				<h:inputHidden id="pageLoad" value="#{adminMethodBackingBean.valuesFromSessionForContract}"></h:inputHidden>	
