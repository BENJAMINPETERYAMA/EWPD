					...
					<TABLE width="100%" border="0" cellspacing="0" cellpadding="0">
						<TR>
							...
							<TABLE border="0" cellspacing="0" cellpadding="3"
								...
								<TBODY>
									<TR>
										<TD height="25" width="168"><h:outputText value="Indicative " />
										</TD>
										<TD width="177"><h:outputText id="indDesc"
											value="#{indicativeMappingBackingBean.indicativeSegmentDesc}" />
									...
									<TR>
										...
										<TD width="177"><h:outputText
											value="#{indicativeMappingBackingBean.segmentNumber}" /></TD>

									</TR>
									<TR>
										<TD height="25" width="168"><h:outputText
											value="SPS Parameter " /></TD>
										<TD width="177"><h:outputText
											value="#{indicativeMappingBackingBean.spsParameterDesc}" />
										</TD>
									</TR>
									...
									<TR>
										...
										<TD width="177"><h:outputText
											value="#{indicativeMappingBackingBean.benefit}" /></TD>
									</TR>
									...
									<TR>
										...
										<TD width="177"><h:outputText
											value="#{indicativeMappingBackingBean.indMapDesc}" /></TD>
									</TR>
									<TR>
										<TD height="25" width="168"><h:outputText id="createdBy"
											value="Created By" /></TD>
										<TD width="176"><h:outputText
											value="#{indicativeMappingBackingBean.createdUser}" /></TD>
									</TR>
									<TR>
									...
									<TR>
										...
										<TD width="176"><h:outputText
											value="#{indicativeMappingBackingBean.lastUpdatedUser}" /></TD>
									</TR>
									<TR>
...
<form name="printForm"><input id="currentPrintPage" type="hidden"
	name="currentPrintPage" value="printIndicativeMappingPage" /></form>
