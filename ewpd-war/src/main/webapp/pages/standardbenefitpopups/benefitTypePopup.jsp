			...
			<TBODY>
					...
					<table width="100%" border="0" cellspacing="1" cellpadding="0"
						...
						<TR>
							<TD width="8%" align="center" valign="middle">
								<h:selectBooleanCheckbox onclick="checkAll_ewpd(this,'termForm:termTable'); ">
								</h:selectBooleanCheckbox>
							</TD>
							<TD width="94%" align="center">
								<strong><h:outputText value="Benefit Type "></h:outputText></strong>
							</TD>
						</TR>
					</table>
					</TD>
				...
				<tr>
					...
					<h:dataTable rowClasses="dataTableEvenRow,dataTableOddRow"
						...
						value="#{ReferenceDataBackingBeanCommon.entityTypeListForSearch}" var="eachRow"
						...
						<h:column>
							...
							<h:inputHidden value="#{eachRow}"></h:inputHidden>
							<h:inputHidden value="#{eachRow}"></h:inputHidden>
							<f:verbatim>&nbsp;</f:verbatim>
							<h:outputText value="#{eachRow}"></h:outputText>
