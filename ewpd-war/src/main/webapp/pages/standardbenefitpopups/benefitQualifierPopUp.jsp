...
.providerArrangementDescriptionColumn {
	width: 15%;
}
.providerArrangementcodeColumn {
	width: 87%;
}
	...
	<h:inputHidden value="#{ReferenceDataBackingBeanCommon.refDataLookupRecords}"></h:inputHidden>
		...
		<tr id="tr3">
								...
								<td width="70%" align="center"><strong><h:outputText
									value="Benefit Term Qualifier " styleClass="outputText"></h:outputText></strong></td>
							</tr>
						...
						<table id="businessEntityTable2"  width="100%" cellpadding="0"
							...
							<tr id="tr4">
								<td  width="8%" align="center" valign="middle"><input name="checkbox" type="checkbox"
									id="checkall"
									onClick="checkAll_ewpd(this,'benefitTermSelectPopupForm:searchResultTable2');"></td>
...
<h:dataTable
									...
									bgcolor="#cccccc" 
									columnClasses="selectOrOptionColumn, providerArrangementDescriptionColumn, providerArrangementcodeColumn" >


									<h:column>
										
										<h:selectBooleanCheckbox styleClass="selectBooleanCheckbox"
										id="parCheckBox" value="#{providerArrangement.termCheckBx}" >
...
<h:dataTable
									...
									value="#{ReferenceDataBackingBeanCommon.refDataLookUpList}"
									bgcolor="#cccccc" 
									columnClasses="selectOrOptionColumn, providerDescriptionColumn, providercodeColumn">
...
matchCheckboxItems_ewpd('benefitTermSelectPopupForm:searchResultTable2',window.dialogArguments.selectedValues,2,2,2);
...
if(sort != null && sort.value == 'code'){
			tigra_tables('benefitTermSelectPopupForm:searchResultTable1',0,0,'#ffffff','#e1ecf7','#ffccff','#cc99ff');
	...
	div4.style.height = '1px';
            ...
            tigra_tables('benefitTermSelectPopupForm:searchResultTable2',0,0,'#ffffff','#e1ecf7','#ffccff','#cc99ff');
...
getCheckedItems_ewpd('benefitTermSelectPopupForm:searchResultTable2',2);return false;
}
}
</script>
</HTML>
