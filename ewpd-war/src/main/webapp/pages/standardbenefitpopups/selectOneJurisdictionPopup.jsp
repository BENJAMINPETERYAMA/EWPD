	...
	<BODY>
		<h:form id="stateCodeForm">
            ...
            <tr>
				...
				<tr>
					<td align="left">
						<h:commandButton id="selectButton" value="Select" styleClass="wpdbutton" onclick="getCheckedItems_ewpd('stateCodeForm:jurisdictionSelectPopupTable',2);return false;"></h:commandButton>
					</td>
				</tr>
			...
			<tr>
				<td><h:dataTable cellspacing="1" width="100%"
					...
					<h:column>
						<f:verbatim>
							<wpd:singleRowSelect groupName="jurisdiction" id="minor" rendered="true"></wpd:singleRowSelect>

						</f:verbatim>
					</h:column>
					<h:column>
									
									<h:inputHidden id="hiddenTermValue" value="#{eachRow.description}" />
									<h:inputHidden id="hiddenTermValueDesc" value="#{eachRow.primaryCode}" />
                                    <h:inputHidden id="hiddenCatalogId" value="#{eachRow.parentCatalogId}"></h:inputHidden>
									<h:outputText id="termValue" value="#{eachRow.description}"></h:outputText>
								</h:column> 
				</h:dataTable></td>
			</tr>
