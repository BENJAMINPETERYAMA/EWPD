	...
	<h:inputHidden value="#{ReferenceDataBackingBeanCommon.refDataLookupRecords}"></h:inputHidden>
		...
		<tr id="tr3">
								...
								<td width="10%" align="center" valign="middle"><input name="checkbox" type="checkbox"
									id="checkall"
									onClick="checkAll_ewpd(this,'providerArrangementForm:searchResultTable1');"></td>
								<td width="20%"></td>
...
<h:dataTable
									...
									value="#{ReferenceDataBackingBeanCommon.refDataLookUpList}"
									bgcolor="#cccccc"
									columnClasses="selectOrOptionColumn,providerDescriptionColumn,shortDescriptionColumn"> >
