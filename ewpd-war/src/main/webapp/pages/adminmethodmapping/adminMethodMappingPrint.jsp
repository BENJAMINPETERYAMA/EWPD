...
document.getElementById('breadcrumb').innerHTML = 'Administration >> Admin Method ('+doc.getElementById('AdminMethodMappingViewForm:adminMethodNo').innerHTML+') >> Mapping Print';
window.print();
</script>
</HTML>
