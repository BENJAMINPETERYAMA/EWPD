...
<f:view>
<BODY onkeypress="return submitOnEnterKey('generateReportForm:nextReportButton');">
<hx:scriptCollector id="scriptCollector1">
	...
	<TABLE width="110%" cellpadding="0" cellspacing="0">
		<TR>
			<TD>
				<jsp:include page="../navigation/top_migration_Print.jsp"></jsp:include>
			</TD>
		</TR>
		<TR>
			<TD>
...
<!-- Space for Tree  Data	-->						
								<!--	<jsp:include page="migrationTree.jsp"></jsp:include>	-->	
									<jsp:include page ="migrationWizardTree.jsp">  </jsp:include>	
						 		</DIV>
							</TD>
					...
					<TABLE>
						<TR>
							<TD><w:message value="#{migrationReportBackingBean.validationMessages}"></w:message>
							</TD>
						</TR>
					</TABLE>
<!-- Table containing Tabs -->
					<table width="100%" border="0" cellpadding="0" cellspacing="0" id="TabTable">
						...
						<tr>
							<td width="100%"><b>Step9 : Report Generation </b> </td>
						</tr>
						<tr>
							 <td>This page will list all coded variables in the selected legacy contract that are not yet mapped to any benefit line in the ET Auto Bagging Product.</td>
						</tr>
						<tr>
							<td>&nbsp;</td>
						</tr>
...
<%--
<h:inputHidden id="loadPricingInfoList" value= "#{migrationReportBackingBean.loadPrisingInfoList}"/> 
		--%>		
					<div id="panel2Content" style="height:256px;position:relative;z-index:1;font-size:10px;overflow:auto;">
...
<br>
				<TABLE>
					<TBODY>
							<TR>
								<TD>
									<h:commandButton styleClass="wpdbutton" value="Back"  action="#{migrationReportBackingBean.back}" > </h:commandButton>
								</TD>
								<TD> &nbsp;</TD>
								<TD>
									<h:commandButton styleClass="wpdbutton" value="Next" id="nextReportButton"  action="#{migrationReportBackingBean.next}" > </h:commandButton>
								</TD>
								<TD> &nbsp;</TD>
							</TR>
					</TBODY>
	...
	function hideResultDiv() {
		...
		if(document.getElementById('generateReportForm:resultsTable') != null) {
			...
			if(document.getElementById('generateReportForm:resultsTable').offsetHeight >= 106) {
				...
				document.getElementById('generateReportForm:resultsTable').width = (relTblWidth-17)+"px";
				syncTables('resultHeaderTable','generateReportForm:resultsTable');	
