...
%>
<TITLE>Major Heading Notes Popup</TITLE>
<BASE target="_self" />
</HEAD>
<f:view>
	<BODY onunload="getCheckedItems()">
	<script language="JavaScript" src="../../js/tigra_tables.js"></script>
	<h:form id="legacyMajorNotesForm">
			...
			<TBODY>
					...
					<table width="100%" border="0" cellspacing="1" cellpadding="0"
						...
						<TR>
							...
							<TD width="94%" align="center"><strong><h:outputText
								value="General Benefits"></h:outputText></strong></TD>
						</TR>
					</table>
					</TD>
				</TR>
				<tr>
					...
					<DIV id="popupDataTableDiv" class=popupDataTableDiv><h:dataTable
						...
						width="100%" id="majorNotesTable"
						value="#{legacyContractBackingBean.majorNotesList}"
						rendered="#{legacyContractBackingBean.majorNotesList != null}"
						var="eachRow" cellpadding="0" bgcolor="#cccccc">
						<h:column>
								<h:selectBooleanCheckbox id="selectMajorNts" styleClass="selectBooleanCheckbox"
 					 			value="#"  >
							</h:selectBooleanCheckbox>
						</h:column>
						<h:column>
							
							<h:outputText value="#{eachRow.majorNotes}"></h:outputText>
						</h:column>
					</h:dataTable></DIV>
					</td>
					<h:inputHidden id="checkboxFlag" value="#{legacyContractBackingBean.majorNotesFlag}"></h:inputHidden>
				</tr>
			</TBODY>
		</table></div><TABLE>
							<TBODY>
...
<script>
if(document.getElementById('legacyMajorNotesForm:checkboxFlag').value=='Y'){
	var notesObject = document.getElementById('legacyMajorNotesForm:majorNotesTable');
	if(notesObject!=null){
...
function getCheckedItems(){
	window.returnValue = document.getElementById('legacyMajorNotesForm:checkboxFlag').value;
	return false;
}
function selectFn(){
	document.body.onunload = "";
	getCheckedFlag('legacyMajorNotesForm:majorNotesTable');
	return false;
}
