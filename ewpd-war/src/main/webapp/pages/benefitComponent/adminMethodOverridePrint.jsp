...
<TR>
			...
			<TR>
				<TD>
					<FIELDSET style="margin-left:10px;margin-right:-1px;padding-bottom:1px;padding-top:1px;width:100%">
			...
			<TR>
				<TD>
					&nbsp;
							...
							<h:inputHidden id="loadPageforPrint" value="#{adminMethodBackingBean.loadBenefitCompPageForPrint}"></h:inputHidden>
