...
<TITLE>Non Adjudication Benefit Mandates</TITLE>
<%
...
<f:view>
	...
	<table width="100%" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td><h:form styleClass="form" id="nonAdjbenefitMandateForm">
...
<script language="javascript">
	...
	function initialize(){
		if(document.getElementById('nonAdjbenefitMandateForm:searchResultTable') != null) {
			setColumnWidth('nonAdjbenefitMandateForm:searchResultTable', '25%:25%:25%:25%');
