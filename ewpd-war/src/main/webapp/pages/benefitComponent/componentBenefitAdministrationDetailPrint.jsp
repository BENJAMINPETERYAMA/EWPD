...
<f:view>
	...
	<h:form styleClass="form" id="benefitAdministrationDetailedPrintForm">
		...
		<TABLE width="100%" cellpadding="0" cellspacing="0" border="0" >
			<TR>
				<TD>
				<h:inputHidden value="#{adminOptionBackingBean.valuesFromSessionForBenefitComp}"></h:inputHidden>
				<fieldset
					style="margin-left:6px;margin-right:-6px;padding-bottom:1px;padding-top:6px;width:99%">
				<div id="adminDiv" align="center" >
					<h:outputText rendered="#{adminOptionBackingBean.adminOptionList == null}"
										value="No Benefit Administration Option Available."
										styleClass="dataTableColumnHeader" />
				</div>
				<DIV id="searchResultdataTableDiv" border="1" bordercolor="blue" >
			...
			<TR>
				<TD>
				<h:inputHidden id="pageLoad" value="#{adminMethodBackingBean.valuesFromSessionForBenefitComp}"></h:inputHidden>	
