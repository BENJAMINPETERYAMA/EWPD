...
<%-- jsf:pagecode language="java" location="/JavaSource/pagecode/pages/adminoptions/AdminOptionUniqueReferenceValidationPrint.java" --%><%-- /jsf:pagecode --%>
<HTML>
<HEAD>
...
<TITLE>Reference Validation Print</TITLE>
</HEAD>
<f:view>
	<BODY>
						...
						<TABLE width="100%" cellspacing="0" cellpadding="0">
							...
							<TR>
								...
								<DIV id="searchResultdataTableQuestDiv"
									style="height:200px;position:relative;z-index:1;font-size:10px;">
