		...
		<DIV id="spsDiv">
			...
			<table width="98%" border="0" cellspacing="1" cellpadding="0" bgcolor="#cccccc" align="center">
					<tr class="dataTableColumnHeader" style="background-color:#cccccc;">
						<TD align="left" width="10%"><h:selectBooleanCheckbox
								onclick="checkAll_ewpd(this,'spsIdForm:spsDataTable'); ">
				...
				<TBODY>
					...
					<tr>
						...
						<h:dataTable cellspacing="1" id="spsDataTable" 
							...
							rowClasses="dataTableOddRow,dataTableEvenRow" columnClasses="selectOrOptionColumn,shortDescriptionColumn,longDescriptionColumn"
						    width="100%">
							<h:column>
