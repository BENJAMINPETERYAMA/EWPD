...
<f:view>
	<BODY>
		...
		<h:inputHidden id="spsMappingView"
			value="#{spsMappingSearchBackingBean.spsMappingView}"></h:inputHidden>
		
		<TABLE cellpadding="0" cellspacing="0">
			<TR>
				<TD width="1000"><jsp:include page="../navigation/top_view.jsp"></jsp:include></TD>
			</TR>

			<TR>
				<TD width="1000"><br/><h:form styleClass="form" id="spsMappingViewForm">
							<FIELDSET
						...
						<br/>	<!--	End of Page data	--></TD>
						</TR>
				<TR>
				<TD width="1000"><br/><%@include file="../navigation/bottom_view.jsp"%></TD>
				</TR>
					</TABLE>
