				...
				<TR id="tr1">					
					<TD>	
						<Div id="resultList" style="height:270px;overflow:auto">				
							...
							var="eachRow" cellpadding="0" bgcolor="#cccccc" columnClasses="selectOrOptionColumn,primaryCodeColumn,subCatalogColumn,shortDescriptionColumn">
							 	<!-- WAS 6.0 Migration Changes - WAS 7.0 not supports f:attribute hence removed from h:column -->
							 	<h:column>
