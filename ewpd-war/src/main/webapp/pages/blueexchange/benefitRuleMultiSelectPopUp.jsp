		...
		<table width="98%" align="right" cellpadding="0" cellspacing="0">
			<TBODY>
					...
					<table width="100%" border="0" cellspacing="1" cellpadding="0"
						...
						<TR height="20">
							...
							<TD width="60%"><strong><h:outputText
								value="Header Rule"></h:outputText></strong></TD>
							<TD width="10%"></TD>
						</TR>
					</table>
					</TD>
				...
				<tr>
					...
					<h:dataTable rowClasses="dataTableEvenRow,dataTableOddRow" columnClasses="selectOrOptionColumn,ruleidDescriptionColumn,ruleDescriptionColumn,viewDescriptionColumn "
