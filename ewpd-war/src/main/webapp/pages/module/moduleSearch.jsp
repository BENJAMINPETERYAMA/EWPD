...
<TITLE>Search Module Page</TITLE>
...
<f:view>
	<body onkeypress="return submitOnEnterKey('searchForm:basicSearch');">
		<h:inputHidden id="dummy"
			value="#{moduleSearchBackingBean.moduleName}" />
								...
								<TR>
									<td valign="top" class="ContentArea">
										<TABLE width="100%">
											<TR>
												<TD><w:message
														value="#{moduleSearchBackingBean.validationMessages}"></w:message></TD>
											</TR>
												...
												<DIV id="searchPanel" onclick="enableRadio()">
													...
													<DIV id="searchPanelContent" class="tabContentBox"
														...
														<h:selectOneRadio id="radioBtn"
															value="#{moduleSearchBackingBean.srdaFlag}">
															...
															<TBODY>
																<TR>
																	<TD valign="top" width="20%"><h:outputText
																			id="moduleName" value="Module Name"></h:outputText></TD>
																...
																<TR>
																	<TD valign="top" width="20%"><h:outputText
																			id="taskName" value="Task Name"></h:outputText></TD>
																	<TD width="15%">
																	...
																	<TD>&nbsp;&nbsp;&nbsp; <h:commandButton
																			...
																			onclick="invokeTaskPopup();
															return false;"
																			tabindex="2">
																		</h:commandButton> <h:inputHidden id="moduleString"
																			value="#{moduleSearchBackingBean.taskId}">
																		</h:inputHidden>
																	</TD>
																...
																<TR>
																	<TD align="left" valign="top" colspan="3"><h:commandButton
																			...
																			value="Locate"
																			action="#{moduleSearchBackingBean.moduleSearch}"
													...
													<DIV id="panel2Content" class="tabContentBox"
														...
														<table cellpadding="0" cellspacing="0" width="100%"
																			...
																			<TBODY>
																				<TR class="dataTableColumnHeader">
																					<TD align="left"><h:outputText
																							value="Module Name"></h:outputText></TD>
																					<TD align="left"><h:outputText
																...
																<td>
																	...
																	<DIV id="searchResultdataTableDiv"
																		...
																		<h:dataTable headerClass="dataTableHeader"
																			...
																			rendered="#{moduleSearchBackingBean.searchResultList != null}"
																			value="#{moduleSearchBackingBean.searchResultList}"
																			rowClasses="dataTableEvenRow,dataTableOddRow"
																			border="0" width="100%">
																			<h:column>
																				<h:outputText id="modName"
																					value="#{singleValue.moduleName}"></h:outputText>
																				<h:inputHidden id="moduleId"
																					value="#{singleValue.moduleId}"></h:inputHidden>
																			</h:column>
															...
															<h:commandLink id="editButton"
																action="#{moduleBackingBean.loadEditPage}"
																style="hidden">
																<f:verbatim> &nbsp;&nbsp;</f:verbatim>
															</h:commandLink>
															<h:inputHidden id="selectedModuleId"
																value="#{moduleBackingBean.selectedModuleId}"></h:inputHidden>
															<h:inputHidden id="selectedModuleIdForDelete"
																value="#{moduleSearchBackingBean.selectedModuleId}" />
															<h:commandLink id="deleteModule"
																style="display:none; visibility: hidden;"
																action="#{moduleSearchBackingBean.deleteModule}">
																<f:verbatim> &nbsp;&nbsp;</f:verbatim>
															</h:commandLink>
															<TR>
																<TD></TD>
		...
		<script language="JavaScript">
			...
			function invokeTaskPopup() {
				if (document.getElementById('searchForm:radioBtn:0').checked === true) {
					ewpdModalWindow_ewpd(
							'../popups/selectTaskPopup.jsp?number=' + number,
							'moduleDiv', 'searchForm:moduleString', 2, 1);
				} else {
					ewpdModalWindow_ewpd(
							'../popups/selectSrdaTaskPopup.jsp?number='
									+ number, 'moduleDiv',
							'searchForm:moduleString', 2, 1);
				}
			}
			...
			function confirmDeletion() {
				...
				if (window.confirm(message)) {
					getFromDataTableToHidden('searchForm:searchResultTable',
							'moduleId', 'searchForm:selectedModuleIdForDelete');
					submitLink('searchForm:deleteModule');
				} else {
					return false;
				}
			}
			function editAction() {
				getFromDataTableToHidden('searchForm:searchResultTable',
						'moduleId', 'searchForm:selectedModuleId');
			...
			function viewAction() {
				...
				window
						.showModalDialog(
								'../module/moduleGeneralInformationView.jsp'
										+ getUrl()
										+ '?moduleId='
										+ document
												.getElementById('searchForm:selectedModuleId').value
										+ '&action=' + action + '&temp='
										+ Math.random(), 'ViewModule',
								'dialogHeight:800px;dialogWidth:1000px;resizable=true;status=no;');
			}

			copyHiddenToDiv_ewpd('searchForm:moduleString', 'moduleDiv', 2, 1);
		</script>
