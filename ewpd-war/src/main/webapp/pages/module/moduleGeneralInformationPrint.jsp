...
<f:view>
	...
	<table width="100%" cellpadding="0" cellspacing="20">
		<tr>
			<td><h:form styleClass="form" id="modulePrintForm">
...
var printForGenInfo = document.getElementById("modulePrintForm:moduleId").value;
if( null == printForGenInfo || "" == printForGenInfo ){
		var genInfoDivObj = document.getElementById('moduleGenInfo');
