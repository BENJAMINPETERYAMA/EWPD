		...
		<table width="100%" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td><h:form styleClass="form" id="benefitComponentCreateForm">
								...
								<TD colspan="2" valign="top" class="ContentArea">
									...
									<div id="resultHeaderDiv" style="width: 100%;">
										...
										<h:dataTable rowClasses="dataTableEvenRow,dataTableOddRow"
											...
											bgcolor="#cccccc"
											value="#{searchResultsBackingBean.benefitComponent}">
											<h:column>
												<f:facet name="header">
													<h:panelGroup>
														...
														<h:commandButton id="asc1" alt="Sort Ascending"
															...
															onclick="setFieldsForSort('Benefit_Components_Name','ASC','1',this);"
														...
														<h:commandButton id="desc1" alt="Sort Descending"
															...
															onclick="setFieldsForSort('Benefit_Components_Name','DESC','1',this);"
															action="#{searchResultsBackingBean.sort}"
															style="margin-left:3">
														</h:commandButton>
													</h:panelGroup>
												</f:facet>
												<h:outputText id="name" value="#{item.name}"></h:outputText>
												...
												<f:facet name="header">
													<h:panelGroup>
														...
														<h:commandButton id="asc2" alt="Sort Ascending"
															...
															onclick="setFieldsForSort('Benefit_Components_Effective_date','ASC','2',this);"
															action="#{searchResultsBackingBean.sort}"
															style="margin-left:3">
														</h:commandButton>
														<h:commandButton id="desc2" alt="Sort Descending"
															...
															onclick="setFieldsForSort('Benefit_Components_Effective_date','DESC','2',this);"
															action="#{searchResultsBackingBean.sort}"
															style="margin-left:3">
														</h:commandButton>
													</h:panelGroup>
												</f:facet>
												<h:outputText id="Qualifier" value="#{item.effectiveDate}">
												...
												<f:facet name="header">
													<h:panelGroup>
														...
														<h:commandButton id="asc3" alt="Sort Ascending"
															...
															onclick="setFieldsForSort('Benefit_Components_Expiry_Date','ASC','3',this);"
															action="#{searchResultsBackingBean.sort}"
															style="margin-left:3">
														</h:commandButton>
														<h:commandButton id="desc3" alt="Sort Descending"
															...
															onclick="setFieldsForSort('Benefit_Components_Expiry_Date','DESC','3',this);"
															action="#{searchResultsBackingBean.sort}"
															style="margin-left:3">
														</h:commandButton>
													</h:panelGroup>
												</f:facet>
												<h:outputText id="header1" value="#{item.expiryDate}">
													<f:convertDateTime pattern="MM/dd/yyyy" />
												</h:outputText>
												<h:inputHidden id="hiddenExpiryDate"
											...
											<h:column>
												<f:facet name="header">
													<h:panelGroup>
														...
														<h:commandButton id="asc4" alt="Sort Ascending" title="Sort Ascending"
															...
															onclick="setFieldsForSort('Benefit_Components_Version','ASC','4',this);"
															action="#{searchResultsBackingBean.sort}"
															style="margin-left:3">
														</h:commandButton>
														<h:commandButton id="desc4" alt="Sort Descending" title="Sort Descending"
															image="#{searchResultsBackingBean.columnFourImageDesc}"
															onclick="setFieldsForSort('Benefit_Components_Version','DESC','4',this);"
															action="#{searchResultsBackingBean.sort}"
															style="margin-left:3">
														</h:commandButton>
													</h:panelGroup>
												...
												<h:inputHidden id="hiddenBCVersion" value="#{item.version}"></h:inputHidden>
											</h:column>
											<h:column>
												<f:facet name="header">
													<h:panelGroup>
														...
														<h:commandButton id="asc5" alt="Sort Ascending" title="Sort Ascending"
															...
															onclick="setFieldsForSort('Benefit_Components_Status','ASC','5',this);"
															action="#{searchResultsBackingBean.sort}"
															style="margin-left:3">
														</h:commandButton>
														<h:commandButton id="desc5" alt="Sort Descending" title="Sort Descending"
															image="#{searchResultsBackingBean.columnFiveImageDesc}"
															onclick="setFieldsForSort('Benefit_Components_Status','DESC','5',this);"
															action="#{searchResultsBackingBean.sort}"
															style="margin-left:3">
														</h:commandButton>
													</h:panelGroup>
											...
											<h:column>
												...
												<h:commandButton id="image"
													alt="List entities to which this is associated to" title="List entities to which this is associated to"
													rendered="#{searchResultsBackingBean.authorizedForAssociation == true}"
													image="../../images/Association.gif"
													onclick="setKeyForView();"
													action="#{searchResultsBackingBean.viewAssociation}">
												</h:commandButton>
												<h:commandButton id="image1" alt="View BenefitComponent" title="View BenefitComponent"
													image="../../images/view.gif" onclick="setKeyForView();"
													rendered="#{searchResultsBackingBean.authorizedForView == true}"
													action="#{searchResultsBackingBean.viewBenefitComponentObject}">
												</h:commandButton>
												<h:commandButton id="image2" alt="More Actions" title="More Actions"
													image="../../images/more_actions.gif"
													action="#{searchResultsBackingBean.viewMoreBenefitComponentObject}"
						...
						<h:inputHidden id="benefitComponentKey"
							value="#{searchResultsBackingBean.benefitComponentKey}" />
						<h:inputHidden id="benefitComponentName"
							value="#{searchResultsBackingBean.benefitComponentName}" />
						...
						<h:inputHidden id="benefitComponentVersion"
							value="#{searchResultsBackingBean.benefitComponentVersion}" />
						<h:inputHidden id="clickedIndex"
							value="#{searchResultsBackingBean.clickedIndex}" />
						<h:inputHidden id="viewAssociation"
							value="#{searchResultsBackingBean.viewAssociation}" />
						<h:inputHidden id="fieldToSort"
							value="#{searchResultsBackingBean.fieldToSort}" />
						<h:inputHidden id="sortOrder"
							value="#{searchResultsBackingBean.benefitComponentSortOrder}" />
						<h:inputHidden id="sortColumn"
							value="#{searchResultsBackingBean.benefitComponentSortColumn}" />
...
<script language="JavaScript">
	...
	function moreActions(object) {
		...
		document
				.getElementById('benefitComponentCreateForm:benefitComponentName').value = objId.value;
...
<script language="JavaScript">
	if (document.getElementById('benefitComponentCreateForm:checkForView').value == 1) {
         benefitComponentSerchResultsActions();
		/* window
				.showModalDialog(
...
<form name="printForm">
	<input id="currentPrintPage" type="hidden" name="currentPrintPage"
		value="benefitcomponentsearchresultsprint" />
</form>
</HTML>
