	...
	<table width="100%" cellpadding="0" cellspacing="0">
		...
		<tr>
				...
				<TD>
					<FIELDSET style="margin-left:16px;margin-right:-10px;padding-bottom:1px;padding-top:1px;width:98%">
						<h:outputText id="breadcrumb" 
							value="Search >> Search Results >> Benefit Components >> Print">
						</h:outputText>
					</FIELDSET>
				</TD>
			</TR>
			<TR>
					...
					<TD colspan="2" valign="top" class="ContentArea">
						...
						<!-- Table containing Tabs -->
								...
								<h:dataTable 
										...
										value="#{searchResultsBackingBean.allBenefitComponent}">
										<h:column>
				  							<f:facet name="header">
												<h:panelGroup>
										...
										<h:column>
											...
											<h:inputHidden id="hiddenBCVersion"
														value="#{item.version}"></h:inputHidden>
										</h:column>
										<h:column>
											<f:facet name="header">
												<h:panelGroup>
				...
				<h:inputHidden id="benefitComponentKey" value="#{searchResultsBackingBean.benefitComponentKey}"/>
				<h:inputHidden id="benefitComponentName" value="#{searchResultsBackingBean.benefitComponentName}"/>
				...
				<h:inputHidden id="benefitComponentVersion" value="#{searchResultsBackingBean.benefitComponentVersion}"/>
				...
				<h:inputHidden id="sortOrder" value="#{searchResultsBackingBean.benefitComponentSortOrder}"/>
				<h:inputHidden id="sortColumn" value="#{searchResultsBackingBean.benefitComponentSortColumn}"/>
...
function moreActions(object){
		...
		var namVarId = urlParts[0] + ":" + urlParts[1] + ":" + urlParts[2] + ":" + "hiddenName";
		...
		document.getElementById('benefitComponentCreateForm:benefitComponentName').value = objId.value;
...
<script language="JavaScript">
	...
	if(document.getElementById('benefitComponentCreateForm:checkForView').value ==1){
 		...
 		window.showModalDialog( '../benefitComponent/benefitComponentView.jsp'+getUrl()+'?'+document.getElementById('benefitComponentCreateForm:query').value+'&temp=' + Math.random(),"",'dialogHeight:800px;dialogLeft:100px;dialogTop:100px;dialogWidth:1000px;resizable=true;status=no;');

	}
	window.print();
	</script>
<form name="printForm"><input id="currentPrintPage" type="hidden"
	name="currentPrintPage" value="benefitcomponentsearchresultsprint" /></form>
</HTML>
