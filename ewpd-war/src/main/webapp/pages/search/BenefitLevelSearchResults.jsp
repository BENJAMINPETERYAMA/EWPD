...
<f:view>
	...
	<table width="100%" cellpadding="0" cellspacing="0">
								...
								<h:dataTable 
										...
										<h:panelGroup>
											<h:outputText value="Qualifier"> </h:outputText>
												...
												<h:commandButton id="asc2" alt="Sort Ascending" 
														...
														onclick="setFieldsForSort('Benefit_Level_Qualifier','ASC','2',this);" 
													...
													<h:commandButton id="desc2"
													    ...
													    onclick="setFieldsForSort('Benefit_Level_Qualifier','DESC','2',this);" 
														action="#{searchResultsBackingBean.sort}"
														style="margin-left:3">
													</h:commandButton>			
										...
										<h:panelGroup>
											<h:outputText value="Description"> </h:outputText>
													...
													<h:commandButton id="asc3" alt="Sort Ascending" 
														...
														onclick="setFieldsForSort('Benefit_Level_Description','ASC','3',this);" 
														action="#{searchResultsBackingBean.sort}"
														style="margin-left:3">
													</h:commandButton>
													<h:commandButton id="desc3"
													    ...
													    onclick="setFieldsForSort('Benefit_Level_Description','DESC','3',this);" 
														action="#{searchResultsBackingBean.sort}"
														style="margin-left:3">
													</h:commandButton>	
										...
										<h:panelGroup>
											<h:outputText value="Provider Arrangement"> </h:outputText>
												...
												<h:commandButton id="asc4" alt="Sort Ascending" 
											   			image="#{searchResultsBackingBean.columnFourImageAsc}"  
														onclick="setFieldsForSort('Benefit_Line_Pva','ASC','4',this);" 
														action="#{searchResultsBackingBean.sort}"
														style="margin-left:3">
													</h:commandButton>
													<h:commandButton id="desc4"
													    ...
													    onclick="setFieldsForSort('Benefit_Line_Pva','DESC','4',this);" 
														action="#{searchResultsBackingBean.sort}"
														style="margin-left:3">
													</h:commandButton>			
										...
										<h:commandButton id="image"
										   alt="List entities to which this is associated to" rendered="#{searchResultsBackingBean.authorizedForAssociation == true}"
		...
		<tr><td><%@ include file="../navigation/bottom.jsp"%></td></tr>
