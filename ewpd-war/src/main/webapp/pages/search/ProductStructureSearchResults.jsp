	...
	<table width="100%" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td><h:form styleClass="form" id="benefitComponentCreateForm">
					...
					<TR>
						...
						<!--  table starts -->
								<h:dataTable 
										...
										value="#{searchResultsBackingBean.productStructure}">
										<h:column>
											<f:facet name="header">
												<h:panelGroup>
													...
													<h:commandButton id="asc1" alt="Sort Ascending" title="Sort Ascending" 
														...
														onclick="setFieldsForSort('Product_Structures_Name','ASC','1',this);" 
													...
													<h:commandButton id="desc1"
													    ...
													    onclick="setFieldsForSort('Product_Structures_Name','DESC','1',this);" 
														action="#{searchResultsBackingBean.sort}"
														style="margin-left:3">
													</h:commandButton>
												</h:panelGroup>
											</f:facet>
											<h:outputText id="sample" value="#{item.name}"></h:outputText>
											<h:inputHidden id="hiddenproductstructurename" value="#{item.name}"/>
										</h:column>
										<h:column>
											<f:facet name="header">
												<h:panelGroup>
													...
													<h:commandButton id="asc2" alt="Sort Ascending" title="Sort Ascending" 
														...
														onclick="setFieldsForSort('Product_Structures_Effective_date','ASC','2',this);" 
														action="#{searchResultsBackingBean.sort}"
														style="margin-left:3">
													</h:commandButton>
													<h:commandButton id="desc2"
													    ...
													    onclick="setFieldsForSort('Product_Structures_Effective_date','DESC','2',this);" 
														action="#{searchResultsBackingBean.sort}"
														style="margin-left:3">
													</h:commandButton>
												</h:panelGroup>
											...
											<f:facet name="header">
												<h:panelGroup>
													<h:outputText value="Expiry Date"></h:outputText>
														...
														onclick="setFieldsForSort('Product_Structures_Expiry_Date','ASC','3',this);" 
														action="#{searchResultsBackingBean.sort}"
														style="margin-left:3">
													</h:commandButton>
													<h:commandButton id="desc3"
													    ...
													    onclick="setFieldsForSort('Product_Structures_Expiry_Date','DESC','3',this);" 
														action="#{searchResultsBackingBean.sort}"
														style="margin-left:3">
													</h:commandButton>
												</h:panelGroup>
											...
											<f:facet name="header">
												<h:panelGroup>
													...
													<h:commandButton id="asc4" alt="Sort Ascending" title="Sort Ascending"
														...
														onclick="setFieldsForSort('Product_Structures_Version','ASC','4',this);" 
														action="#{searchResultsBackingBean.sort}"
														style="margin-left:3">
													</h:commandButton>
													<h:commandButton id="desc4"
													    ...
													    onclick="setFieldsForSort('Product_Structures_Version','DESC','4',this);" 
														action="#{searchResultsBackingBean.sort}"
														style="margin-left:3">
													</h:commandButton>
												</h:panelGroup>
											...
											<f:facet name="header">
												<h:panelGroup>
													...
													<h:commandButton id="asc5" alt="Sort Ascending" title="Sort Ascending"
														...
														onclick="setFieldsForSort('Product_Structures_Status','ASC','5',this);" 
														action="#{searchResultsBackingBean.sort}"
														style="margin-left:3">
													</h:commandButton>
													<h:commandButton id="desc5"
													    ...
													    onclick="setFieldsForSort('Product_Structures_Status','DESC','5',this);" 
														action="#{searchResultsBackingBean.sort}"
														style="margin-left:3">
													</h:commandButton>
												</h:panelGroup>
										...
										<h:commandButton id="image1"
										   alt="View Product Structure" title="View Product Structure"
										   image="../../images/view.gif" onclick="setKeyForView();" rendered="#{searchResultsBackingBean.authorizedForView == true}" action="#{searchResultsBackingBean.viewProductStructureObject}">
										</h:commandButton>  
											<f:verbatim> &nbsp; </f:verbatim>
										<h:commandButton id="image2"
										   alt="More Actions" title="More Actions"
										   image="../../images/more_actions.gif"  action="#{searchResultsBackingBean.viewMoreProductStructureObject}"
				...
				<h:inputHidden id="productstructurename" value="#{searchResultsBackingBean.productstructurename}"/>
				<h:inputHidden id="productStructureId" value="#{searchResultsBackingBean.productStructureId}"/>
				...
				<h:inputHidden id="sortOrder" value="#{searchResultsBackingBean.productStructureSortOrder}"/>
				<h:inputHidden id="sortColumn" value="#{searchResultsBackingBean.productStructureSortColumn}"/>
...
<script language="JavaScript">
	...
	function moreActions(object){
		...
		var namVarId = urlParts[0] + ":" + urlParts[1] + ":" + urlParts[2] + ":" + "hiddenproductstructurename";
		...
		document.getElementById('benefitComponentCreateForm:productstructurename').value = objId.value;
	}
...
<script language="JavaScript">
	var checkForViewValue = document.getElementById('benefitComponentCreateForm:checkForView').value ;
	if(checkForViewValue == 1)
	{
		productStructureSerchResultsActions();
		/* var currentDate = new Date();
		var currentTime = currentDate.getTime();
		var id = document.getElementById('benefitComponentCreateForm:productStructureId').value;
 		window.showModalDialog('../productStructure/viewProductStructureGeneralInformation.jsp'+getUrl()+'?id='+id+'&date='+currentTime,'','dialogHeight:800px;dialogWidth:1026px;resizable=false;status=no;'); */
	 }
</script>
<form name="printForm"><input id="currentPrintPage" type="hidden"
	name="currentPrintPage" value="productstructuresearchresultsprint" /></form>
</HTML>
