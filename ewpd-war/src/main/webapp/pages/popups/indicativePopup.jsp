				...
				<tr>
					...
					<h:dataTable rowClasses="dataTableEvenRow,dataTableOddRow"
						...
						<h:column>
							...
							<h:inputHidden value="#{indicativeDetails.segment}" />
							<h:inputHidden value="#{indicativeDetails.description}" />		
							<h:inputHidden value="#{indicativeDetails.segmentNumber}" />	
...
if(hiddenObj.value) {
	matchCheckboxItems_ewpd('itemCodeForm:catalogSelectPopupTable', window.dialogArguments.selectedValues, 3, 1, 1);
}
