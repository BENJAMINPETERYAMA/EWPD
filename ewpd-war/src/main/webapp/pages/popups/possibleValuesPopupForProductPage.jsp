...
<f:view>
	<body>
	    <h:form styleClass="form" id="psvlPopupProduct">
		<h:inputHidden value="#{productBenefitDetailBackingBean.psvlLookupRecords}" id="psvlLookupRecords"></h:inputHidden>
		<table width="100%">
			<tr>
		...
		<table width="100%">
			<tr>
				<td>
					<h:dataTable width="100%" id="tierDataTable" value="#{productBenefitDetailBackingBean.pbvlDefList}" var="eachRow" 
						bgcolor="#cccccc" cellpadding="2" cellspacing="1"
        				rendered="#{productBenefitDetailBackingBean != null}" border="0" rowClasses="dataTableEvenRow,dataTableOddRow"
...
function stateMaintain(){
	...
	var tabObj = document.getElementById("psvlPopupProduct:tierDataTable").childNodes[1];
	var tbSize = document.getElementById('psvlPopupProduct:tierDataTable').rows.length;
