		...
		<table width="98%" align="right" cellpadding="0" cellspacing="0">
			<TBODY>
					...
					<table width="100%" border="0" cellspacing="1" cellpadding="0"
						...
						<tr>
							<td width="10%" align="center" valign="middle"><h:selectBooleanCheckbox
								onclick="checkAllid(this,'popupForm:componentDataTable','benefitChkBox'); "></h:selectBooleanCheckbox></TD>
				...
				<tr>
					...
					<h:dataTable cellspacing="1" width="100%" id="componentDataTable"
...
function expandcontract(dis) {
	...
	if(dis.keyCode=='13'){
		...
		ajaxCall1('../popups/ajaxHelperTableIndicativeMultipleForAccumulator.jsp?entityId='+entityId+'&queryName='+queryName+'&headerName='+headerName+'&benefitLvlId='+benefitLvlId+'&temp='+Math.random(),searchField,divObj,'popupForm:componentDataTable',errorMsgDiv,attrObj,'','popupForm:checkId');
		return false;
	}
}
