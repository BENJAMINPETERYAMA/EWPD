...
<f:view>
	...
	<h:inputHidden id="componentKey"
					value="#{notesBackingBean.componentValues}">
				</h:inputHidden>
		<table border="0" cellpadding="5" cellspacing="0" width="100%">
			<tr>
				<td>
					<TABLE>
									<TBODY>
								<TR>
									<TD><TABLE><TR><TD><w:messageForPopup></w:messageForPopup></TD></TR></TABLE></TD>
								</TR>
								</TBODY>
								</TABLE>
				</td>
			...
			<tr>
				...
				<td align="left">&nbsp;<h:commandButton id="selectButton" value="Select"
					...
					onclick="getCheckedItems_ewpd('benefitComponentForm:benefitComponentTable',2);return false;"></h:commandButton>
				</td>
			</tr>
			...
			<TBODY>
					...
					<table width="100%" border="0" cellspacing="1" cellpadding="0"
						...
						<TR>
							<TD width="8%" align="center" valign="middle">
								<h:selectBooleanCheckbox onclick="checkAll_ewpd(this,'benefitComponentForm:benefitComponentTable'); ">
								</h:selectBooleanCheckbox>
							</TD>
							<TD width="94%" align="center">
								<strong><h:outputText value="Benefit Component"></h:outputText></strong>
							</TD>
						</TR>
					</table>
					</TD>
				...
				<tr>
					...
					columnClasses="selectOrOptionColumn,shortDescriptionColumn"
						cellspacing="1" width="100%" id="benefitComponentTable"
...
<script language="javascript">
	...
	if(hiddenObj.value) {
		...
		matchCheckboxItems_ewpd('benefitComponentForm:benefitComponentTable', window.dialogArguments.selectedValues, 2, 2, 2);
	}
</script>
</HTML>
