		...
		<table border="0" cellpadding="5" cellspacing="0" width="100%">
		     ...
		     <tr>
				<td align="left">&nbsp;<h:commandButton id="selectButton" value="Select"
					...
					onclick="getCheckedItems_ewpd('popupForm:componentDataTable',3);return false;"></h:commandButton>
				</td>
			</tr>
				...
				<tr>
					...
					<table width="100%" border="0" cellspacing="1" cellpadding="0"
						...
						<tr>
							...
							<TD width="94%" align="left" height="27"><strong> <h:outputText value="#{popupBackingBean.headerName}" styleClass="outputText"></h:outputText></strong></td>
						</tr>
						<tr>
							<td width="6%" align="center" height="13"></TD>
							<TD width="94%" align="left" height="13"><h:inputText styleClass="formInputField"
											id="txtSearch"
						...
						<div id="searchResultdataTableDiv" class="popupDataTableDiv" style="height:300px;">
							<h:dataTable id="componentDataTable"  
								   ...
								   cellspacing="1" bgcolor="#cccccc" 
									rendered="#{popupBackingBean.searchList != null}" border="0" rowClasses="dataTableEvenRow,dataTableOddRow" columnClasses="singleRowSelectColumn,descriptionColumn">
								        ...
								        <h:column >
                                           <f:verbatim>&nbsp;</f:verbatim>
											<h:inputHidden value="#{eachRow.segment}"></h:inputHidden>
											<h:inputHidden value="#{eachRow.description}"></h:inputHidden>
											<h:inputHidden value="#{eachRow.segmentNumber}"></h:inputHidden>										
...
function expandcontract(dis) {
	if(dis.keyCode=='13'){
		...
		ajaxCall1('../popups/ajaxHelperTableIndicativeSingle.jsp?entityId='+entityId+'&queryName='+queryName+'&headerName='+headerName+'&benefitLvlId='+benefitLvlId+'&temp='+Math.random(),searchField,divObj,'popupForm:componentDataTable',errorMsgDiv,attrObj,'','popupForm:checkId');
		return false;
	}
}
...
matchCheckboxItems_ewpd('popupForm:componentDataTable',window.dialogArguments.selectedValues,3,2,2);
