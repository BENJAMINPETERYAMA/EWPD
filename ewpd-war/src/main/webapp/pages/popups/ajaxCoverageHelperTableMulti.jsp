...
<f:view>
				...
				<h:dataTable headerClass="dataTableHeader" id="searchResultTable1test" var="providerArrangement" cellpadding="2" 
						...
						border="0" rowClasses="dataTableEvenRow,dataTableOddRow"  columnClasses="selectOrOptionColumn,shortDescriptionColumn,longDescriptionColumn">
                              <h:column>
									...
									<h:inputHidden id="hiddenPrimaryCode" value="#{providerArrangement.primaryCode}" />
									<h:inputHidden id="hiddenTermVal" value="#{providerArrangement.description}"/>
              				    </h:column>                         
                              <h:column>
	...
	<h:inputHidden id="recordsGreaterThanMaxSize"
			value="#{ReferenceDataBackingBeanCommon.recordsGreaterThanMaxSize}"></h:inputHidden>
						<h:outputText value="$$~"></h:outputText>
						<h:outputText value="*#~"></h:outputText>
