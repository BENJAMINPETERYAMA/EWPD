			...
			<TABLE border="0" cellpadding="5" cellspacing="0" width="100%">
				<TR>
					<TD align="left" height="19">&nbsp;<INPUT type="button" id="selectButton"
						...
						onclick="getSelected();return false;" disabled="disabled"></TD>
				</TR>
			...
			<TABLE width="98%" border="0" align="right" cellpadding="0"
				...
				<TR>
					...
					<TABLE id="businessEntityTable1" width="100%" cellpadding="0"
						...
						<TR>
							...
							<TD width="25%" align="left" valign="middle" height="23"><h:inputText
							...
							<TD width="65%" align="left" height="23"></TD>
						</TR>
					</TABLE>
					</DIV>
					</TD>
				...
				<TR id="tr1">
					...
					<DIV id="popupTableDiv1" style="overflow:auto;"
						...
						border="0" rowClasses="dataTableEvenRow,dataTableOddRow" columnClasses="singleRowSelectColumn,descriptionColumn,anotherDescriptionColumn">
						<h:column>
...
function getSelected(){
      if(sort != null && sort.value == 'code'){ 
            getCheckedItems_ewpd('benefitTermSelectPopupForm:searchResultTable1test',2);return false;
      }
...
function expandcontract(dis) {
      if(dis.keyCode=='13'){
            ...
            ajaxCall1('../popups/ajaxCoverageHelperTable.jsp?parentCatalog='+parentCatalog+'&lookUpAction='
						+lookUpAction+'&lob='+lob+'&be='+be+'&bg='+bg+'&entityType='+entityType+'&temp='+Math.random(),searchField,divObj,
						'benefitTermSelectPopupForm:searchResultTable1test',errorMsgDiv,attrObj,'','');
            return false;
