...
<f:view>
	...
	<h:inputHidden id="productKey"
					value="#{notesBackingBean.productValues}">
				</h:inputHidden>
		...
		<table border="0" cellpadding="5" cellspacing="0" width="96%">
			...
			<tr>
				<td align="left">&nbsp;<h:commandButton id="selectButton" value="Select"
					...
					onclick="getCheckedItems_ewpd_notes('productForm:productTable',2);return false;"></h:commandButton>
				</td>
			</tr>
			...
			<TBODY>
					...
					<table width="100%" border="0" cellspacing="1" cellpadding="0"
						...
						<TR>
							<TD width="8%" align="center" valign="middle">
								<h:selectBooleanCheckbox onclick="checkAll_ewpd(this,'productForm:productTable'); ">
				...
				<tr>
					...
					<h:dataTable rowClasses="dataTableEvenRow,dataTableOddRow"
						...
						cellspacing="1" cellpadding="1" width="100%" id="productTable"
						value="#{notesBackingBean.productList}" var="eachRow"
						cellpadding="0" bgcolor="#cccccc">
						<h:column>
							
								<h:selectBooleanCheckbox id="productChkBox">
								</h:selectBooleanCheckbox>
...
<script language="javascript">
	...
	if(hiddenObj.value) {
		...
		matchCheckboxItems_ewpd('productForm:productTable', window.dialogArguments.selectedValues, 2, 2, 2);
	}
