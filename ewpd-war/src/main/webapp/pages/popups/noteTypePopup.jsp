		...
		<table border="0" cellpadding="5" cellspacing="0" width="100%">
			...
			<tr>
				<td align="left">&nbsp;<h:commandButton id="selectButton" value="Select"
					...
					onclick="getCheckedItems_ewpd('noteTypeForm:noteTypeTable',2);return false;"></h:commandButton>
				</td>
			</tr>
		</table>
			...
			<TBODY>
					...
					<table width="100%" border="0" cellspacing="1" cellpadding="0"
						...
						<TR>
							<TD width="8%" align="center" valign="middle">
								<h:selectBooleanCheckbox onclick="checkAll_ewpd(this,'noteTypeForm:noteTypeTable'); ">
								</h:selectBooleanCheckbox>
							</TD>
							<TD width="92%" align="center">
								<strong><h:outputText value="Note Type "></h:outputText></strong>
							</TD>
						</TR>
					</table>
					</TD>
				...
				<tr>
					...
					columnClasses="selectOrOptionColumn,shortDescriptionColumn"
						cellspacing="1" width="100%" id="noteTypeTable"
						value="#{ReferenceDataBackingBeanCommon.refDataLookUpList}" var="eachRow"
						cellpadding="0" bgcolor="#cccccc" >
						<h:column>
						
								<h:selectBooleanCheckbox id="noteTypeChkBox">
								</h:selectBooleanCheckbox>
...
<script language="javascript">
	...
	if(hiddenObj.value) {
		...
		matchCheckboxItems_ewpd('noteTypeForm:noteTypeTable', window.dialogArguments.selectedValues, 2, 2, 2);
	}
</script>
</HTML>
