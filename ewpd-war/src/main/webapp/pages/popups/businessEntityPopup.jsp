		...
		<table width="98%" align="right" cellpadding="0" cellspacing="0" border="0">
				...
				<TR>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0"
						...
						<TR id="tr3">
							<TD width="10%" align="center" valign="middle"><h:selectBooleanCheckbox
								onclick="checkAll_ewpd(this,'businessEntityForm:businessEntityDataTable1'); ">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0"
						...
						<TR id="tr4">
							<TD width="10%" align="center" valign="middle"><h:selectBooleanCheckbox
								onclick="checkAll_ewpd(this,'businessEntityForm:businessEntityDataTable2'); ">
							</h:selectBooleanCheckbox></TD>
                            <td width="20%"></td>
							<TD align="left" width="70%"><strong><h:outputText
								value="Business Entity"></h:outputText></strong></TD>
				...
				<tr id="tr1">
					...
					<h:dataTable rowClasses="dataTableEvenRow,dataTableOddRow" columnClasses="selectOrOptionColumn,shortDescriptionColumn,longDescriptionColumn"
						cellspacing="1" width="100%" id="businessEntityDataTable1"
                ...
                <tr id="tr2">
					...
					<h:dataTable rowClasses="dataTableEvenRow,dataTableOddRow" columnClasses="selectOrOptionColumn,shortDescriptionColumn,longDescriptionColumn"
						cellspacing="1" width="100%" id="businessEntityDataTable2"
						value="#{ReferenceDataBackingBeanCommon.refDataLookUpList}"
                        rendered="#{!ReferenceDataBackingBeanCommon.renderFirstList}" var="eachRow"
						cellpadding="0" bgcolor="#cccccc">
						<h:column>
							<h:selectBooleanCheckbox id="businessEntityChkBox2">
							</h:selectBooleanCheckbox>
...
<script language="javascript">
	...
	document.getElementById('businessEntityForm:selectButton').disabled  = false;
	
    matchCheckboxItems_ewpd('businessEntityForm:businessEntityDataTable1',window.dialogArguments.selectedValues,2,2,2);
    matchCheckboxItems_ewpd('businessEntityForm:businessEntityDataTable2',window.dialogArguments.selectedValues,2,2,2);
	var sort = document.getElementById('businessEntityForm:hiddensortorder');
	...
	if(sort != null && sort.value == 'code'){
		tigra_tables('businessEntityForm:businessEntityDataTable1',0,0,'#ffffff','#e1ecf7','#ffccff','#cc99ff');
	    ...
	    tigra_tables('businessEntityForm:businessEntityDataTable2',0,0,'#ffffff','#e1ecf7','#ffccff','#cc99ff');
	...
	getCheckedItems_ewpd('businessEntityForm:businessEntityDataTable1',2);return false;
	}
	else if(sort != null && sort.value == 'desc'){
	
	getCheckedItems_ewpd('businessEntityForm:businessEntityDataTable2',2);return false;
	}
	}
</script>
</HTML>
