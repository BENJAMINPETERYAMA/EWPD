...
<f:view>
	...
	<h:form id="notesLookUpForm">
		<div id="noNotesDiv"><h:inputHidden id="records"
			value="#{contractQuestionTierNotesAttachmentBackingBean.records}"></h:inputHidden>
					...
					<table width="100%" border="0" cellspacing="1" cellpadding="0"
						...
						<TR height="20">
							...
							<TD width="60%"><h:inputText styleClass="formInputField"
								id="txtSearch"
								value="#{contractQuestionTierNotesAttachmentBackingBean.searchString}"
...
if(dis.keyCode=='13'){
document.getElementById("message").style.visibility ='hidden';	
var tierSysId = document.getElementById('notesLookUpForm:tierSysId').value;
...
ajaxCall('../popups/ajaxProductQuestionTierNoteTable.jsp?&questionId='+questionId+
		'&tierSysId='+tierSysId+
