...
<f:view>
	<BODY>
	<h:form id="rolePopupForm">
	<h:inputHidden value="#{taskBackingBean.loadModuleLookUpList}"></h:inputHidden>
		...
		<table border="0" cellpadding="5" cellspacing="0" width="100%">
			<tr>
				<td align="left">&nbsp;<h:commandButton id="selectButton" value="Select" styleClass="wpdbutton"
					onclick="getCheckedItems_ewpd('rolePopupForm:moduleSelectPopupTable',2);return false;"></h:commandButton>
				</td>
			</tr>
		</table>
			...
			<TBODY>
					...
					<table width="100%" border="0" cellspacing="1" cellpadding="0" id="headerTable"
						...
						<tr>
							<TD width="8%" align="center" valign="middle">
								<h:selectBooleanCheckbox onclick="checkAll_ewpd(this,'rolePopupForm:moduleSelectPopupTable'); ">
				...
				<tr>
					...
					columnClasses="selectOrOptionColumn,shortDescriptionColumn"
						...
						rendered="#{taskBackingBean.moduleLookUpList != null}"
						value="#{taskBackingBean.moduleLookUpList}"
...
<script language="javascript">
		initialize();
		function initialize(){
			if(document.getElementById('rolePopupForm:moduleSelectPopupTable') != null) {
				setColumnWidth('rolePopupForm:moduleSelectPopupTable', '40:450');
				setColumnWidth('headerTable', '40:450');
			}else {
				document.getElementById("roleSelectDiv").style.visibility = 'hidden';
			}
		}
		...
		if(hiddenObj.value) {
			...
			matchCheckboxItems_ewpd('rolePopupForm:moduleSelectPopupTable', window.dialogArguments.selectedValues, 2, 2, 2);
