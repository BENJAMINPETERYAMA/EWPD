...
<div id ="noNotesDiv">
		<h:inputHidden id="records"
			value="#{contractBenefitAdministrationBackingBean.records}"></h:inputHidden>
			...
			<TBODY>
					...
					<table width="100%" border="0" cellspacing="1" cellpadding="0"
						...
						<TR height="20">
							...
							<TD width="60%"><h:inputText styleClass="formInputField"
								id="txtSearch"
								value="#{contractBenefitAdministrationBackingBean.searchString}"
				...
				<tr>
					...
					<DIV id="popupDataTableDiv" style="overflow:auto;"
						...
						width="100%" value="#{contractBenefitAdministrationBackingBean.questionNotes}"
						var="singleValue"
						rendered="#{contractBenefitAdministrationBackingBean.questionNotes!=null}"
		...
		<h:inputHidden id="primaryEntytyType"
			value="#{contractBenefitAdministrationBackingBean.primaryType}"></h:inputHidden>
		...
		<h:inputHidden id="benefitDefnId"
			value="#{contractBenefitAdministrationBackingBean.benefitDefnId}"></h:inputHidden>
		...
		<h:inputHidden id="viewNoteId"
			value="#{contractBenefitAdministrationBackingBean.noteId}"></h:inputHidden>
		<h:inputHidden id="viewNoteName"
			value="#{contractBenefitAdministrationBackingBean.noteName}"></h:inputHidden>
		<h:inputHidden id="viewNoteVersion"
			value="#{contractBenefitAdministrationBackingBean.version}"></h:inputHidden>
		<h:inputHidden id="dummyHidden"></h:inputHidden>
		<h:inputHidden id="prevNoteIdSelectedId"
			value="#{contractBenefitAdministrationBackingBean.prevNoteIdSelected}"></h:inputHidden>
		<h:inputHidden id ="prevVersionId"  value ="#{contractBenefitAdministrationBackingBean.previousNoteVersion}"></h:inputHidden>
		<h:inputHidden id ="questionToProcessId"  value ="#{contractBenefitAdministrationBackingBean.questionId}"></h:inputHidden>
		<h:inputHidden id="newNoteId" value="#{contractBenefitAdministrationBackingBean.newNoteId}"></h:inputHidden>
		
		<h:inputHidden id="BCnoteStatus"
			value="#{contractBenefitAdministrationBackingBean.noteStatus}"></h:inputHidden>
		<h:inputHidden id="noteVersion"
			value="#{contractBenefitAdministrationBackingBean.noteVersion}"></h:inputHidden>
		<h:commandLink id="saveLink" style="display:none; visibility: hidden;"
			action="#{contractBenefitAdministrationBackingBean.attachNotesToQuestion}">
		</h:commandLink>
		<h:inputHidden id ="notepresentId"  value ="#{contractBenefitAdministrationBackingBean.noteAttached}"></h:inputHidden>
...
document.getElementById('notesLookUpForm:selectButton').disabled  = false;
</script>
</HTML>
