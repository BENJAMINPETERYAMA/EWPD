...
<f:view>
				...
				<h:dataTable headerClass="dataTableHeader" id="searchResultTable1" var="providerArrangement" cellpadding="2" 
						...
						border="0" rowClasses="dataTableEvenRow,dataTableOddRow" columnClasses="selectcoverageIdColumn,shortDescriptionColumn">
                              <h:column>
								...
								<h:column>
									...
									<h:inputHidden id="hiddenTermValueDesc" value="#{providerArrangement.segment}" />
									<h:inputHidden id="hiddenTermValueNr" value="#{providerArrangement.segmentNumber}" />
