...
<TITLE>Catalog Name Popup</TITLE>
<%
...
<f:view>
	...
	<h:outputText value="No Catalogs Available."
					...
					<table width="100%" border="0" cellspacing="1" cellpadding="0" id="headerTable"
						...
						<tr>
							<TD width="8%" align="center" valign="middle">
								<h:selectBooleanCheckbox onclick="checkAll_ewpd(this,'itemCodeForm:catalogSelectPopupTable'); ">
								</h:selectBooleanCheckbox>
							</TD>
							<TD width="94%" align="center"><strong> <h:outputText value="Catalog Name">
...
<script language="javascript">
		...
		function initialize(){
			if(document.getElementById('itemCodeForm:catalogSelectPopupTable') != null) {
				setColumnWidth('itemCodeForm:catalogSelectPopupTable', '40:450');
		...
		if(hiddenObj.value) {
			...
			matchCheckboxItems_ewpd('itemCodeForm:catalogSelectPopupTable', window.dialogArguments.selectedValues, 2, 2, 2);
