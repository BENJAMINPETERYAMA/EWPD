...
<f:view>
	<BODY>
	<h:form id="moduleTaskPopupForm">
	<h:outputText value="No Tasks Available."
								rendered="#{moduleBackingBean.taskList == null}"
		...
		<table border="0" cellpadding="5" cellspacing="0" width="100%">
			...
			<tr>
				<td align="left">&nbsp;<h:commandButton id="selectButton" value="Select" styleClass="wpdbutton"
					onclick="getCheckedItems_ewpd('moduleTaskPopupForm:taskSelectPopupTable',2);return false;"></h:commandButton>
				</td>
			</tr>
		</table>
			...
			<TBODY>
					...
					<table width="100%" border="0" cellspacing="1" cellpadding="0" id="headerTable"
						...
						<tr>
							<TD width="8%" align="center" valign="middle">
								<h:selectBooleanCheckbox onclick="checkAll_ewpd(this,'moduleTaskPopupForm:taskSelectPopupTable'); ">
				...
				<tr>
					...
					<h:dataTable rowClasses="dataTableEvenRow,dataTableOddRow"
						...
						id="taskSelectPopupTable" var="taskName" rendered="#{moduleBackingBean.taskList != null}"
						value="#{moduleBackingBean.taskList}"
...
<script language="javascript">
		initialize();
		function initialize(){
			if(document.getElementById('moduleTaskPopupForm:taskSelectPopupTable') != null) {
				setColumnWidth('moduleTaskPopupForm:taskSelectPopupTable', '40:450');
		...
		if(hiddenObj.value) {
			...
			matchCheckboxItems_ewpd('moduleTaskPopupForm:taskSelectPopupTable', window.dialogArguments.selectedValues, 2, 2, 2);
