		...
		<table border="0" cellpadding="5" cellspacing="0" width="100%">
		     ...
		     <tr>
				<td align="left">&nbsp;<h:commandButton id="selectButton" value="Select"
					...
					onclick="attachValueToInputs('popupForm:componentDataTable',3);return false;"></h:commandButton>
				</td>
			</tr>
			...
			<TBODY>
				...
				<tr>
					...
					<table width="100%" border="0" cellspacing="1" cellpadding="0"
						bgcolor="#cccccc">
						<tr>
							<td width="3%" align="center" height="13"></TD>
							<td align="center" height="13" width="9%"><strong> <h:outputText value="SPS Id" styleClass="outputText"></h:outputText></strong></TD>
							<TD align="center" height="27" width="85%"><strong> <h:outputText value="#{popupBackingBean.headerName}" styleClass="outputText"></h:outputText></strong></td>
						</tr>
						<tr>
							<td width="6%" align="center" height="13"></TD>
							<td align="center" height="27" width="9%">
							<TD align="center" height="13" width="85%"><h:inputText styleClass="formInputField"
											id="txtSearch"
						...
						<div id="searchResultdataTableDiv" class="popupDataTableDiv" style="height:300px;">
							<h:dataTable id="componentDataTable"  
								   ...
								   cellspacing="1" bgcolor="#cccccc" 
									rendered="#{popupBackingBean.searchList != null}" border="0" rowClasses="dataTableEvenRow,dataTableOddRow" columnClasses="singleRowSelectColumn,descriptionColumn,anotherDescriptionColumn" >
								        ...
								        <h:column >
											...
											<h:inputHidden value="#{eachRow.cobolValue}"></h:inputHidden>
...
function expandcontract(dis) {
	if(dis.keyCode=='13'){
		...
		ajaxCall1('../popups/ajaxHelperTableReferenceSingleselect.jsp?entityId='+entityId+'&queryName='+queryName+'&headerName='+headerName+'&benefitLvlId='+benefitLvlId+'&temp='+Math.random(),searchField,divObj,'popupForm:componentDataTable',errorMsgDiv,attrObj,'','popupForm:checkId');
		return false;
	}
}
...
matchCheckboxItems_ewpd('popupForm:componentDataTable',window.dialogArguments.selectedValues,3,1,1);
