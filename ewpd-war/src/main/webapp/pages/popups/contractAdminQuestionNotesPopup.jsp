...
<div id="noNotesDiv">
		<h:inputHidden id="records"
			value="#{contractProductAdminOptionOverrideBackingBean.records}"></h:inputHidden>
			...
			<TBODY>
					...
					<table width="100%" border="0" cellspacing="1" cellpadding="0"
						...
						<TR height="20">
							...
							<TD width="60%"><h:inputText styleClass="formInputField"
								id="txtSearch"
								value="#{contractProductAdminOptionOverrideBackingBean.searchString}"
				...
				<tr>
					...
					<DIV id="popupDataTableDiv" style="overflow:auto;"
						...
						width="100%" value="#{contractProductAdminOptionOverrideBackingBean.questionNotes}"
						var="singleValue"
						rendered="#{contractProductAdminOptionOverrideBackingBean.questionNotes!=null}"
		...
		<h:inputHidden id="questionId"
			value="#{contractProductAdminOptionOverrideBackingBean.questionId}"></h:inputHidden>
		<h:inputHidden id="primaryentityId"
			value="#{contractProductAdminOptionOverrideBackingBean.primaryEntityID}"></h:inputHidden>
		<h:inputHidden id="primaryEntytyType"
			value="#{contractProductAdminOptionOverrideBackingBean.primaryType}"></h:inputHidden>
		<h:inputHidden id="benefitComponentId"
			value="#{contractProductAdminOptionOverrideBackingBean.benefitComponentId}"></h:inputHidden>
		<h:inputHidden id="adminOptionId"
			value="#{contractProductAdminOptionOverrideBackingBean.adminOptionId}"></h:inputHidden>
		<h:inputHidden id="viewNoteId"
			value="#{contractProductAdminOptionOverrideBackingBean.noteId}"></h:inputHidden>
		<h:inputHidden id="viewNoteName"
			value="#{contractProductAdminOptionOverrideBackingBean.noteName}"></h:inputHidden>
		<h:inputHidden id="viewNoteVersion"
			value="#{contractProductAdminOptionOverrideBackingBean.version}"></h:inputHidden>
		<h:inputHidden id="dummyHidden"></h:inputHidden>
		<h:inputHidden id="prevNoteIdSelectedId"
			value="#{contractProductAdminOptionOverrideBackingBean.prevNoteIdSelected}"></h:inputHidden>
		<h:inputHidden id ="prevVersionId"  value ="#{contractProductAdminOptionOverrideBackingBean.previousNoteVersion}"></h:inputHidden>
		<h:inputHidden id ="questionToProcessId"  value ="#{contractProductAdminOptionOverrideBackingBean.questionId}"></h:inputHidden>
		<h:inputHidden id="newNoteId" value="#{contractProductAdminOptionOverrideBackingBean.newNoteId}"></h:inputHidden>
		
		<h:inputHidden id="BCnoteStatus"
			value="#{contractProductAdminOptionOverrideBackingBean.noteStatus}"></h:inputHidden>
		<h:inputHidden id="noteVersion"
			value="#{contractProductAdminOptionOverrideBackingBean.noteVersion}"></h:inputHidden>
		<h:commandLink id="saveLink" style="display:none; visibility: hidden;"
			action="#{contractProductAdminOptionOverrideBackingBean.attachNotesToQuestion}">
		</h:commandLink>
		<h:inputHidden id ="notepresentId"  value ="#{contractProductAdminOptionOverrideBackingBean.noteAttached}"></h:inputHidden>
...
ajaxCall('../popups/ajaxHelperContractQuestionNoteTable.jsp?&questionId='+questionId+
