...
<f:view>
	...
	<h:form id="popupForm">
		...
		<h:inputHidden id="records"
			value="#{popupBackingBean.recordsForAdminMethodPopup}"></h:inputHidden>
		<table width="100%">
			<TBODY>
				<TR>
					<TD>
		...
		<table border="0" cellpadding="5" cellspacing="0" width="100%">
			...
			<tr>
				<td align="left">&nbsp;<h:commandButton id="selectButton"
					...
					onclick="attachValueToInputsAdmin('popupForm:componentDataTable',3);return false;"></h:commandButton>
				</td>
			</tr>
			...
			<TBODY>
				...
				<tr>
					...
					<table width="100%" border="0" cellspacing="1" cellpadding="0"
						bgcolor="#cccccc">
						<tr>
							<td width="5%" align="left" height="27"><strong> <h:outputText
								value="" styleClass="outputText"></h:outputText></strong></TD>
							<td width="15%" align="left" height="27"><strong> <h:outputText
								value="Number" styleClass="outputText"></h:outputText></strong></TD>
							<TD width="80%" align="left" height="27"><strong> <h:outputText
								value="Description" styleClass="outputText"></h:outputText></strong></td>
						</tr>
						<tr>
							<td width="5%" align="left" height="13"></TD>
							<td width="15%" align="left" height="13"></TD>
							<TD width="80%" align="left" height="13"><h:inputText
				...
				<tr>
					...
					<div id="searchResultdataTableDiv" class="popupDataTableDiv"
						...
						columnClasses="selectcoverageIdColumn,shortDescriptionColumn,longDescriptionColumn">
					...
					<table cellpadding="7" cellspacing="1" bgcolor="#cccccc" border="0"
						...
						<tr>
							<td bgcolor="#e1ecf7" colspan="2" width="100%"
								style="font-family: Verdana, Arial, Helvetica, sans-serif; font-weight: bold; font-size: 9px;"><font
								color="red">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;An
							unknown error occurred during processing.</font></td>
						</tr>
					</table>
					</div>
					</TD>
		...
		<h:inputHidden id="spsIdHidden" value="#{popupBackingBean.spsId}"></h:inputHidden>
...
function expandcontract(dis) {
	if(dis.keyCode=='13'){
		...
		var spsId = document.getElementById('popupForm:spsIdHidden').value;
		...
		ajaxCall1('../popups/ajaxHelperTableAdminMethodingle.jsp?entityId='+entityId+'&queryName='+queryName+'&headerName='+headerName+'&spsId='+spsId+'&temp='+Math.random(),searchField,divObj,'popupForm:componentDataTable',errorMsgDiv,attrObj,'','popupForm:checkId');
		return false;
	}
}
