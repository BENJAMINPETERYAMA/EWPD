		...
		<h:form id="benefitTermSelectPopupForm">
			...
			<TABLE border="0" width="98%">
				<TR>
					<TD align="left" height="19">&nbsp;<INPUT type="button"
						...
						onclick="getSelectedValues();return false;"></TD>
				</TR>
			...
			<TABLE width="98%" border="0" align="right" cellpadding="0"
				...
				<TR id="tr1">
					...
					<h:column>
					<h:dataTable
						headerClass="dataTableHeader" id="searchResultTable1test2"
						var="answer" cellpadding="2" width="100%"
						cellspacing="1" bgcolor="#cccccc"
						rendered="#{question.possibleAnswerIdList!=null}"
						value="#{question.possibleAnswerIdList}"
						border="0" rowClasses="dataTableEvenRow,dataTableOddRow">
						<h:column>
						
						<h:outputText id="termVasslue"
								value="#{answer}"
								style="padding-left: 5px"></h:outputText>

					<h:outputText id="termVassl22ue"
								value="#{answer}+1"
								style="padding-left: 5px"></h:outputText>
