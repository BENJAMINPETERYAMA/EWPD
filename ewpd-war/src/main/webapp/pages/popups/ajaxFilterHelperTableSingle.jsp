...
<h:dataTable id="componentDataTable"  
				   value="#{popupBackingBean.filteredSearchList}" var="eachRow"  cellpadding="2" 
				   cellspacing="1" bgcolor="#cccccc" 
					rendered="#{popupBackingBean.filteredSearchList != null}" border="0" rowClasses="dataTableEvenRow,dataTableOddRow" columnClasses="selectOrOptionColumn,shortDescriptionColumn" width="100%">
