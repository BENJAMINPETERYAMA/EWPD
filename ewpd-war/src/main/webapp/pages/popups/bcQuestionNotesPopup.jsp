...
<f:view>
	...
	<div id="noNotesDiv">
		<h:inputHidden id="records"
			value="#{BenefitComponentAdministrationBackingBean.records}"></h:inputHidden>
			...
			<TBODY>
					...
					<table width="100%" border="0" cellspacing="1" cellpadding="0"
						...
						<TR height="20">
							...
							<TD width="60%"><h:inputText styleClass="formInputField"
								id="txtSearch"
								value="#{BenefitComponentAdministrationBackingBean.searchString}"
				...
				<tr>
					...
					<DIV id="popupDataTableDiv" style="overflow:auto;"
						...
						columnClasses="selectOrOptionColumn,shortDescriptionColumn,longDescriptionColumn,selectOrOptionColumn"
						width="100%" value="#{BenefitComponentAdministrationBackingBean.questionNotes}"
						var="singleValue"
						rendered="#{BenefitComponentAdministrationBackingBean.questionNotes!=null}"
		...
		<h:inputHidden id="primaryEntytyType"
			value="#{BenefitComponentAdministrationBackingBean.primaryType}"></h:inputHidden>
		...
		<h:inputHidden id="benefitDefnId"
			value="#{BenefitComponentAdministrationBackingBean.benefitDefnId}"></h:inputHidden>
		...
		<h:inputHidden id="viewNoteId"
			value="#{BenefitComponentAdministrationBackingBean.noteId}"></h:inputHidden>
		<h:inputHidden id="viewNoteName"
			value="#{BenefitComponentAdministrationBackingBean.noteName}"></h:inputHidden>
		<h:inputHidden id="viewNoteVersion"
			value="#{BenefitComponentAdministrationBackingBean.version}"></h:inputHidden>
		<h:inputHidden id="dummyHidden"></h:inputHidden>
		<h:inputHidden id="prevNoteIdSelectedId"
			value="#{BenefitComponentAdministrationBackingBean.prevNoteIdSelected}"></h:inputHidden>
		<h:inputHidden id ="prevVersionId"  value ="#{BenefitComponentAdministrationBackingBean.previousNoteVersion}"></h:inputHidden>
		<h:inputHidden id ="questionToProcessId"  value ="#{BenefitComponentAdministrationBackingBean.questionId}"></h:inputHidden>
		<h:inputHidden id="newNoteId" value="#{BenefitComponentAdministrationBackingBean.newNoteId}"></h:inputHidden>
		
		<h:inputHidden id="BCnoteStatus"
			value="#{BenefitComponentAdministrationBackingBean.noteStatus}"></h:inputHidden>
		<h:inputHidden id="noteVersion"
			value="#{BenefitComponentAdministrationBackingBean.noteVersion}"></h:inputHidden>
		<h:commandLink id="saveLink" style="display:none; visibility: hidden;"
			action="#{BenefitComponentAdministrationBackingBean.attachNotesToQuestion}">
		</h:commandLink>
		<DIV id="dummyDiv" style="visibility:hidden"></DIV>
		<h:inputHidden id ="notepresentId"  value ="#{BenefitComponentAdministrationBackingBean.noteAttached}"></h:inputHidden>
	</h:form>
	</BODY>
</f:view>
