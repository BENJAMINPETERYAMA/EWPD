			...
			<TBODY>
				...
				<tr>
					...
					<table width="100%" border="0" cellspacing="1" cellpadding="0"
						bgcolor="#cccccc">
						<tr>
							<td width="20%" align="center" height="27"><strong> <h:outputText value="Code" styleClass="outputText"></h:outputText></strong></TD>
							<TD width="90%" align="center" height="27"><strong> <h:outputText value="#{popupBackingBean.headerName}" styleClass="outputText"></h:outputText></strong></td>
						</tr>
						<tr>
							<td width="10%" align="center" height="13"></TD>
							<TD width="90%" align="center" height="13"><h:inputText styleClass="formInputField"
											id="txtSearch"
...
function expandcontract(dis) {
	if(dis.keyCode=='13'){
		...
		ajaxCall1('../popups/ajaxHelperTableSPSSingle.jsp?entityId='+entityId+'&queryName='+queryName+'&headerName='+headerName+'&benefitLvlId='+benefitLvlId+'&temp='+Math.random(),searchField,divObj,'popupForm:componentDataTable',errorMsgDiv,attrObj,'','popupForm:checkId');
		return false;
	}
}
