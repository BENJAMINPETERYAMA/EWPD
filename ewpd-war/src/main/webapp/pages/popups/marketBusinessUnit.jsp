...
<TITLE>Market Business Unit</TITLE>
<%
			...
			<TBODY>
                  <TR>
					...
					<table width="100%" border="0" cellspacing="1" cellpadding="0"
						...
						<TR id="tr3">
							<TD width="10%" align="center" valign="middle"><h:selectBooleanCheckbox
								onclick="checkAll_ewpd(this,'businessUnitForm:businessUnitDataTable1'); ">
							</h:selectBooleanCheckbox></TD>
                            <td width="20%"></td>
							<TD align="left" width="70%"><strong><h:outputText
								value="Market Business Unit"></h:outputText></strong></TD>
						</TR>
					</table>
                    </DIV>
					...
					<table width="100%" border="0" cellspacing="1" cellpadding="0"
						...
						<TR id="tr4">
							<TD width="10%" align="center" valign="middle"><h:selectBooleanCheckbox
								onclick="checkAll_ewpd(this,'businessUnitForm:businessUnitDataTable2'); ">
							</h:selectBooleanCheckbox></TD>
                            <td width="20%"></td>
							<TD align="left" width="70%"><strong><h:outputText
								value="Market Business Unit"></h:outputText></strong></TD>
				...
				<tr id="tr1">
					...
					columnClasses="selectOrOptionColumn,shortDescriptionColumn,longDescriptionColumn"
						cellspacing="1" width="100%" id="businessUnitDataTable1"
						...
						<h:column>
							...
							<h:selectBooleanCheckbox id="businessUnitChkBox">
             ...
             <tr id="tr2">
					...
					columnClasses="selectOrOptionColumn,longDescriptionColumn,shortDescriptionColumn"
						cellspacing="1" width="100%" id="businessUnitDataTable2"
						value="#{ReferenceDataBackingBeanCommon.refDataLookUpList}"
                        rendered="#{!ReferenceDataBackingBeanCommon.renderFirstList}" var="eachRow"
						cellpadding="0" bgcolor="#cccccc">
						<h:column>
						
							<h:selectBooleanCheckbox id="businessUnitChkBox2">
							</h:selectBooleanCheckbox>
...
<script language="javascript">
    ...
    matchCheckboxItems_ewpd('businessUnitForm:businessUnitDataTable1',window.dialogArguments.selectedValues,2,2,2);
    matchCheckboxItems_ewpd('businessUnitForm:businessUnitDataTable2',window.dialogArguments.selectedValues,2,2,2);
	var sort = document.getElementById('businessUnitForm:hiddensortorder');
	...
	if(sort != null && sort.value == 'code'){
		tigra_tables('businessUnitForm:businessUnitDataTable1',0,0,'#ffffff','#e1ecf7','#ffccff','#cc99ff');
	    ...
	    tigra_tables('businessUnitForm:businessUnitDataTable2',0,0,'#ffffff','#e1ecf7','#ffccff','#cc99ff');
	...
	function getSelected(){
		if(sort != null && sort.value == 'code'){
			getCheckedItems_ewpd('businessUnitForm:businessUnitDataTable1',2);return false;
		}
		else if(sort != null && sort.value == 'desc'){
			getCheckedItems_ewpd('businessUnitForm:businessUnitDataTable2',2);return false;
		}
	}
</script>
</HTML>
