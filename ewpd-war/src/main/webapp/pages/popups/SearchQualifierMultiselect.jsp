			...
			<TBODY>
				...
				<tr>
					...
					<table width="100%" border="0" cellspacing="1" cellpadding="0"
						bgcolor="#cccccc">
						<tr>
							<td width="10%" align="left" height="27"><h:selectBooleanCheckbox id="checkId"
								onclick="checkAllid(this,'popupForm:componentDataTable','componentChkBox'); "></h:selectBooleanCheckbox></TD>
							<TD width="20%" align="left" height="27"><strong> <h:outputText value="" styleClass="outputText"></h:outputText></strong></td>
							<TD width="70%" align="left" height="27"><strong> <h:outputText value="Qualifier" styleClass="outputText"></h:outputText></strong></td>
						</tr>
						<tr>
							<td width="10%" align="left" height="13"></TD>
							<td width="20%" align="left" height="13"></TD>
							<TD width="70%" align="left" height="13"><h:inputText styleClass="formInputField"
											id="txtSearch"
					...
					<TD> 
						<div id="searchResultdataTableDiv" class="popupDataTableDiv" style="height:300px;">
							<h:dataTable id="componentDataTable"  
								   ...
								   cellspacing="1" bgcolor="#cccccc" width="100%"
