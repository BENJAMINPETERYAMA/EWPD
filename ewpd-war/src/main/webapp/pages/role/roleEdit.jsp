...
<f:view>
	<BODY onkeypress="return submitOnEnterKey('roleEditForm:save');">
	<table width="100%" cellpadding="0" cellspacing="0">
		<h:inputHidden id="dummy"
			value="#{roleBackingBean.treeBreadCrumbText}" />
		<TR>
			<TD><jsp:include page="../navigation/top_Print.jsp"></jsp:include></TD>
		</TR>
		<tr>
			<td><h:form styleClass="form" id="roleEditForm">
					...
					<TR>
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0"
							...
							<tr>
								...
								<td>
								<table width="100%" border="0" cellspacing="0" cellpadding="0" id = "disableTable">
									<tr>
										<td width="2" align="left"><img
											src="../../images/tabNormalLeft.gif" width="3" height="21" /></td>
										<td width="186" class="tabNormal"><h:commandLink
											action="#{roleBackingBean.loadRoleConfiguration}" id="roleId"
											onmousedown="javascript:navigatePageAction(this.id);">
											<h:outputText id="dataDomainTable" value="Authorized Modules" />
										</h:commandLink></td>
							...
							<TBODY>
								...
								<TR>
									<TD width="25%">&nbsp;<h:outputText id="RoleNameStar"
										styleClass="#{roleBackingBean.requiredRoleName ? 'mandatoryError': 'mandatoryNormal'}"
										value="Name*" /></TD>
									<TD align="left" width="30%"><h:outputText
										value="#{roleBackingBean.roleName}" /> <h:inputHidden
								...
								<TR>
									...
									<TD align="left" width="30%"><h:inputTextarea
										...
										value="#{roleBackingBean.description}" tabindex="7"></h:inputTextarea></TD>
									<TD width="40%"></TD>
								</TR>
									<RapidSpellWeb:rapidSpellWebLauncher
										id="rapidSpellWebLauncher1"
										textComponentName="roleEditForm:txtDescription"
								...
								<TR>
									...
									<TD align="left" width="30%"><h:outputText
										value="#{roleBackingBean.createdUser}" /> <h:inputHidden
										id="createdUserHidden" value="#{roleBackingBean.createdUser}" /></TD>
									<TD width="40%"></TD>
								</TR>
								...
								<TR>
									...
									<h:inputHidden id="createdDateHidden"
										value="#{roleBackingBean.createdTimestamp}" ><f:convertDateTime
								...
								<TR>
									...
									<TD align="left" width="30%"><h:outputText
										value="#{roleBackingBean.lastUpdatedUser}" /> <h:inputHidden
								...
								<TR>
									...
									<h:inputHidden id="lastUpdatedDateHidden"
										value="#{roleBackingBean.lastUpdatedTimestamp}" ><f:convertDateTime
								...
								<TR>
									...
									<h:commandButton value="Save" id="save" onmousedown="javascript:savePageAction(this.id);"
										...
										<h:commandLink id="saveRole"
												style="hidden" action="#{roleBackingBean.editRole}">
										</h:commandLink>
									</TD>
								</TR>
...
<!-- space for script -->
<script>
	/*copyHiddenToDiv_ewpd('catalogEditForm:txtLob','lobDiv',2,1); 
	copyHiddenToDiv_ewpd('catalogEditForm:txtBusinessGroup','BusinessGroupDiv',2,1); */
	
	
var srdaData="<%= session.getAttribute("SRDA_FLAG")%>";
if(srdaData==="SRDA"){
document.getElementById('disableTable').style.display = "none";
}else{
	document.getElementById('disableTable').style.display = "inline";
}
...
function spellFin(cancelled){
		...
		document.getElementById('roleEditForm:saveRole').click();	
}
