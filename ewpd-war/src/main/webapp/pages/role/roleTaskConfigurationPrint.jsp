...
<TITLE>Role-Task Configuration Print</TITLE>
<%
...
<f:view>
<BODY>
	<h:form styleClass="form" id="roleTaskPrintForm">
...
<!--	Start of Table for actual Data	-->		
							...
							<DIV id="panel2Header" class="tabTitleBar"
								style="position:relative; cursor:hand;">Tasks</DIV>
							...
							<table cellpadding="0" cellspacing="0" width="100%" border="0">
								...
								<TR>
									...
									<DIV id="searchResultdataTableDiv"
										...
										headerClass="dataTableHeader" id="associatedTaskTable" 
...
<script>
	initialize();
		function initialize(){
			if(document.getElementById('roleTaskPrintForm:associatedTaskTable') == null) 
