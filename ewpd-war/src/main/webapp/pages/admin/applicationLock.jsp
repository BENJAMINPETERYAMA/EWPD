...
<%-- jsf:pagecode language="java" location="/JavaSource/pagecode/pages/navigation/Top.java" --%><%-- /jsf:pagecode --%>
...
<html>
	...
	<table height="80%" align="center">
		...
		<tr height="20%">
			<td><span class="pagetitle">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;eWPD Application is currently not available. Please try again later.</span></td>
		</tr>
		<tr height="60%">
			<td>&nbsp;</td>
		</tr>
