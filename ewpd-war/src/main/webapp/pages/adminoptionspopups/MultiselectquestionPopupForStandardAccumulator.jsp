		...
		<table border="0" cellpadding="5" cellspacing="0" width="100%">
			...
			<tr>
				<td align="left">&nbsp;<h:commandButton id="txtSelect"
					...
					onclick="getCheckedItems_ewpd('questionSelectPopupForm:questionSelectPopupTable',2);return false;"></h:commandButton>
				</td>
			</tr>
		</table>
				...
				<table width="100%" border="0" cellspacing="1" cellpadding="0"
					...
					<tr>
						<td width="10%" align="center" valign="middle"><h:selectBooleanCheckbox
								onclick="checkAllid(this,'questionSelectPopupForm:questionSelectPopupTable','questionChkBox'); "></h:selectBooleanCheckbox></TD>
...
<script language="javascript">
	...
	matchCheckboxItems_ewpd('questionSelectPopupForm:questionSelectPopupTable', window.dialogArguments.selectedValues, 2, 2, 2);
