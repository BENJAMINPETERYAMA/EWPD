...
async function modalWindowforAccumPopupSearch(url, divId, hiddenId, peer_divId,peer_hiddenId){
	...
	var retValue = await window.showModalDialog(url, param, "dialogHeight:450px;dialogWidth:500px;resizable=false;status=no;");	
	if( retValue == undefined ) {
		return false;
	}
	var hiddenValueObj = document.getElementById(hiddenId);
...
async function modalWindowForSingleValueSelect2(url, onScreeenControlId, hiddenId){
	var param = new Object();
	param.parentWindow = window;
	param.hiddenId = hiddenId;
...
async function modalWindowBE(url, divId, hiddenId, peer_divId,peer_hiddenId){
...
async function modalWindow11(url, divId, hiddenId){
...
async function modalWindowaccum(url, divId, hiddenId, peer_divId,peer_hiddenId){
...
async function modalWindowForSingleValueSelect(url, onScreeenControlId, hiddenId){
	var param = new Object();
	param.parentWindow = window;
	param.hiddenId = hiddenId;
...
async function ewpdModalWindow_ewpd(url, targetId, hiddenId, attrCount, attrPos, peer_divId, peer_hiddenId, hiddenIdToDisable){
	...
	var retValue = await window.showModalDialog(url, param, "dialogHeight:465px;dialogWidth:512px;resizable=false;status=no;");	
...
function ewpdModalWindow_import(url,hiddenId,hiddenValue, height, width){	
	...
	async function ewpdModalWindow_ewpdforlob(url, targetId, hiddenId, attrCount, attrPos, peer_divId, peer_hiddenId, hiddenIdToDisable){
		// Creating new object and setting all the values that needs to be passed into the popup screen. These values
		// Object param can be accessed from the popup by "window.dialogArguments".
		var param = new Object();
		param.parentWindow = window;
...
async function ewpdModalWindow_ewpd_AM(url, targetId, hiddenId, attrCount, attrPos, peer_divId, peer_hiddenId, hiddenIdToDisable){
	// Creating new object and setting all the values that needs to be passed into the popup screen. These values
	// Object param can be accessed from the popup by "window.dialogArguments".
	var param = new Object();
	param.parentWindow = window;
...
async function ewpdModalWindow_NotesView(url, targetId, hiddenId, attrCount, attrPos, peer_divId, peer_hiddenId, hiddenIdToDisable){
	// Creating new object and setting all the values that needs to be passed into the popup screen. These values
	// Object param can be accessed from the popup by "window.dialogArguments".
	...
	// Calling popup window.
	var retValue = await window.showModalDialog(url, param, "dialogHeight:300px;dialogWidth:450px;resizable=false;status=no;");	
	// Cancel action from popup. No need to do anything.
	if( retValue == undefined ) {
		return false;
	}
...
async function ewpdModalWindow_ewpd1(url, targetId, hiddenId, attrCount, attrPos, peer_divId, peer_hiddenId, hiddenIdToDisable){
	// Creating new object and setting all the values that needs to be passed into the popup screen. These values
	// Object param can be accessed from the popup by "window.dialogArguments".
	var param = new Object();
	param.parentWindow = window;
	...
	// Calling popup window.
	var retValue = await window.showModalDialog(url, param, "dialogHeight:465px;dialogWidth:500px;resizable=false;status=no;");	
	// Cancel action from popup. No need to do anything.
	if( retValue == undefined ) {
		return false;
	}
...
async function ewpdModalWindowWithRuleType(url,targetId,hiddenId,ruleTypeHidden ,attrCount, attrPos, peer_divId, peer_hiddenId, hiddenIdToDisable){
	// Creating new object and setting all the values that needs to be passed into the popup screen. These values
	// Object param can be accessed from the popup by "window.dialogArguments".
...
/**
	...
	attrPos			- Position of the attribute within the tilda String that needs to be shown in the div/inputText.
					  eg: id1~desc1~name1~id2~desc2~name2 - if 1 is given then id1,id2 will be shwon in div.
														  - if 2 is given then desc1,desc2 will be shown in div.	
*/
async function copyHiddenToDiv_ewpd(hiddenId, divId, attrCount, attrPos) {
...
var url1 = "../pages/contractpopups/validateCopyPopup.jsp"+getUrl()+"?contractKey="+contractSysId+'&dateSegmentId='+dateSegmentSysId+'&productId='+prodid+'&temp='+Math.random();
 ...
 */
async function productPrintSelection(){
	var param = new Object();
	param.parentWindow = window;
	var url = "../popups/productPrintSelectionPopup.jsp"+getUrl();
	newWinForView =await window.showModalDialog(url,param,"dialogHeight:130px;dialogWidth:275px;resizable=false;status=no;");
}
...
else if(printSelectionFlag && printPageValue == 'productAdminMethod')  {
{
  ...
  //  else if(printSelectionFlag &&((printPageValue == 'benefitComponentAdminMethod')||(printPageValue == 'benefitComponentAdminOption')))
	...
	async function getSelectedReasoncode(url, formName, targetDiv, targetHidden, attrCount, attrPosn, parentCatalog){
...
// Function used to send AJAX request using GET Method.
	...
	async function callUncodedNotesNotesPopUp(){
		var url = '../contract/uncodedNotesPopUpSubstitute.jsp'+getUrl()+'?temp='+Math.random();
		var newWinForView = await window.showModalDialog(url,"","dialogHeight:800px;dialogWidth:1200px;resizable=false;status=no;");
	}
...
async function ewpdModalWindow_ewpd_show_code_desc(url, targetId, hiddenId, attrCount, attrPos, peer_divId, peer_hiddenId, hiddenIdToDisable,targettable,modetype){
	// Creating new object and setting all the values that needs to be passed into the popup screen. These values
	// Object param can be accessed from the popup by "window.dialogArguments".
	var param = new Object();
	param.parentWindow = window;
...
async function ewpdModalWindow_termed_contract(url, targetId, hiddenId, attrCount, attrPos, peer_divId, peer_hiddenId, hiddenIdToDisable){
	// Creating new object and setting all the values that needs to be passed into the popup screen. These values
	// Object param can be accessed from the popup by "window.dialogArguments".
	var param = new Object();
	param.parentWindow = window;
...
async function contractSerchResultsActions(){
	var retValue = await window.showModalDialog(
...
async function productSerchResultsActions(){
	var retValue = await window.showModalDialog('../product/productGeneralInformationView.jsp'+getUrl()+'?productKey='+document.getElementById('benefitComponentCreateForm:productKey').value + '&temp=' + Math.random(),'','dialogHeight:800px;dialogWidth:1000px;resizable=true;status=no;');
	if( retValue == undefined ) {
		return false;
	}
}
async function productStructureSerchResultsActions(){
	var currentDate = new Date();
	var currentTime = currentDate.getTime();
	var id = document.getElementById('benefitComponentCreateForm:productStructureId').value;
	var retValue = await window.showModalDialog('../productStructure/viewProductStructureGeneralInformation.jsp'+getUrl()+'?id='+id+'&date='+currentTime,'','dialogHeight:800px;dialogWidth:1026px;resizable=false;status=no;');
		if( retValue == undefined ) {
			return false;
		}
}
async function benefitComponentSerchResultsActions(){
	var retValue = await window
	.showModalDialog(
			'../benefitComponent/benefitComponentView.jsp'
					+ getUrl()
					+ '?'
					+ document
							.getElementById('benefitComponentCreateForm:query').value
					+ '&temp=' + Math.random(),
			"",
			'dialogHeight:800px;dialogLeft:100px;dialogTop:100px;dialogWidth:1000px;resizable=true;status=no;');
	if( retValue == undefined ) {
		return false;
	}
}
async function benefitSerchResultsActions(){
	var retValue = await window.showModalDialog('../standardBenefit/standardBenefitView.jsp'+getUrl()+'?benefitkey='+document.getElementById('benefitComponentCreateForm:benefitKey').value + '&temp=' + Math.random(),'ViewStandardBenefit','dialogHeight:800px;dialogLeft:100px;dialogTop:100px;dialogWidth:1000px;resizable=true;status=no;');
	if( retValue == undefined ) {
		return false;
	}
}
...
function attachValueToInputs(id, attrCount ){

	//attachValueToInputs('popupForm:componentDataTable',3);
	var tableObject;
	if (document.getElementById(id))
	{
		tableObject = document.getElementById(id);	
	...
	var val = selectedValues; 
	
	if((null!=val) && !('' == val)){
		var indr = val.split('~');
		
		console.log(indr);
		window.dialogArguments.parentWindow.document.getElementById('refDiv').innerHTML=indr[0];
		window.dialogArguments.parentWindow.document.getElementById('snDiv').innerHTML=indr[1];
		window.dialogArguments.parentWindow.document.getElementById('DesDiv').innerHTML=indr[2];
		
	
		
	}else{
		console.log('nothing');
		window.dialogArguments.parentWindow.document.getElementById('snDiv').innerHTML='';
		window.dialogArguments.parentWindow.document.getElementById('refDiv').innerHTML='';
		window.dialogArguments.parentWindow.document.getElementById('DesDiv').innerHTML='';
	}
...
function attachValueToInputsAdmin(id, attrCount ){
	...
	if((null!=val) && !('' == val)){
		...
		console.log(indr);
		window.dialogArguments.parentWindow.document.getElementById('amNoDiv').innerHTML=indr[0];
		window.dialogArguments.parentWindow.document.getElementById('DesDiv').innerHTML=indr[1];
		...
		console.log('nothing');
		window.dialogArguments.parentWindow.document.getElementById('amNoDiv').innerHTML='';
		window.dialogArguments.parentWindow.document.getElementById('DesDiv').innerHTML='';
...
async function ewpdModalWindow_ewpd_noteDomain(url, targetId, hiddenId, attrCount, attrPos, peer_divId, peer_hiddenId, hiddenIdToDisable){
// Creating new object and setting all the values that needs to be passed into the popup screen. These values
// Object param can be accessed from the popup by "window.dialogArguments".
var param = new Object();
param.parentWindow = window;
...
function getSelectedDomainReferenceDataNoteDomain(url, formName, busUnitHidden, lobHidden, beHidden, bgHidden, targetDiv, targetHidden, attrCount, attrPosn, parentCatalog){
	var lob = '', be = '', bg = ''; bu= '';
 	lob = getObj(formName+':'+lobHidden).value;
 	be = getObj(formName+':'+beHidden).value;
 	bg = getObj(formName+':'+bgHidden).value;	 	
	...
	if((null != lob && lob != '') && (null != be && be != '') && (null != bg && bg != '') && (null == bu || bu == '')){
		url = url +getUrl()+ '?lookUpAction=2'+'&parentCatalog='+parentCatalog +'&lob='+lob +'&be='+be+'&bg='+bg;
		return ewpdModalWindow_ewpd_noteDomain(url, targetDiv, targetHidden, attrCount, attrPosn);
	}else if((null != lob && lob != '') && (null != be && be != '') && (null != bg && bg != '') && (null != bu && bu != '')){
		url = url +getUrl()+ '?lookUpAction=2'+'&parentCatalog='+parentCatalog +'&lob='+lob +'&be='+be+'&bg='+bg+'&bu='+bu;
		return ewpdModalWindow_ewpd_noteDomain(url, targetDiv, targetHidden, attrCount, attrPosn);
	}else{
...
async function reserveContractNotAvailable(){
	var ret = await window.showModalDialog('../contractpopups/reserveContractIdPopUp.jsp'+getUrl()+ '?temp=' + Math.random(),"",'dialogHeight:650px;dialogWidth:800px;resizable=false;status=no;');
	checkBoxChecked();
...
async function releaseContractAvailable(){
	var ret= await window.showModalDialog('../contractpopups/releaseReservedContractsPopUp.jsp'+getUrl()+ '?temp=' + Math.random(),'','dialogHeight:650px;dialogWidth:800px;resizable=false;status=no;');  
				if(ret=='confirm'){
					document.getElementById('reservedContractForm:releaseReservedLink').click();
				}
}
async function openAddRootQuestion(){
	...
	var retValue = await window.showModalDialog('../questionnaire/helperPopUpForRoot.jsp'+getUrl()+'?'+ 'temp=' + Math.random()+'&&'+'adminOptionId='+adminId+'&&'+'adminOptionName='+escape(adminName)+'&&'+'adminOptionVersion='+adminVersion+'&&submitPage=addRoot','','dialogHeight:600px;dialogLeft:100px;dialogTop:60px;dialogWidth:800px;scrollbars=false;resizable=false;status=no;');	
	if(retValue != undefined){
...
async function openEditRootQuestion(){
	var adminId = document.getElementById('adminOptionQuestionForm:hiddenAdminOptionId').value;
	var adminName = document.getElementById('adminOptionQuestionForm:adminName').value;
	var adminVersion = document.getElementById('adminOptionQuestionForm:version').value;
	var retValue = await window.showModalDialog('../questionnaire/helperPopUpForRoot.jsp'+getUrl()+'?'+ 'temp=' + Math.random()+'&&'+'adminOptionId='+adminId+'&&'+'adminOptionName='+escape(adminName)+'&&'+'adminOptionVersion='+adminVersion+'&&submitPage=editRoot','','dialogHeight:580px;dialogWidth:930px;resizable=false;status=no;');	
	if(retValue == undefined){
...
async function selectQuestion(){	
	...
	var retvalue = await ewpdModalWindow_ewpd('../adminoptionspopups/selectMultipleQuestionPopup.jsp'+getUrl()+'?'+ 'temp=' + Math.random()+'&&'+'adminOptionId='+adminId,'questionSelectDiv','addRootQuestionForm:selectQuesHidden',3,1);
...
async function editQuestionnaire(){
	...
	var retvalue = await window.showModalDialog('../questionnaire/helperPopUp.jsp'+getUrl()+'?adminOptionName='+escape(document.getElementById('adminOptionQuestionForm:adminNameToNextPage').value)+'&adminOptionVersion='+document.getElementById('adminOptionQuestionForm:adminVersionToNextPage').value+'&parentQuestionnaireHierarchyId='+document.getElementById('adminOptionQuestionForm:selectedQuestionnaireId').value + '&temp=' + Math.random(),'EditQuestionnaire','dialogHeight:600px;dialogLeft:20px;dialogTop:60px;dialogWidth:1000px;scrollbars=false;resizable=false;status=no;');
	//submitLink('adminOptionQuestionForm:refreshLink');
...
var newMyObject = await window.showModalDialog(url,myObject,"dialogHeight:800px;dialogWidth:1000px;resizable=true;status=no;");
document.getElementById('ContractBasicSearchForm:comments').value = newMyObject.comments;
document.getElementById('ContractBasicSearchForm:dateEntered').value = newMyObject.dateEntered;
document.getElementById('ContractBasicSearchForm:type').value = newMyObject.type;
document.getElementById('ContractBasicSearchForm:copyLegacyNotesid').value = newMyObject.copylegacyNote; 
if(newMyObject.vValue == '1'){
...
if(newMyObject.vValue == undefined){
	getObj('ContractBasicSearchForm:searchButton').click();
}
}

async function deleteContractParent(){
...
var returnvalue =await  window.showModalDialog(url, myObject, "dialogHeight:150px;dialogWidth:350px;resizable=false;status=no;");	
	...
	{ 
		...
		submitLink('ContractBasicSearchForm:deleteLink');
	}
...
async function copyActionChild(page){
	getFromDataTableToHidden('viewAllVersionForm:previousVersionsTable','contractKey','viewAllVersionForm:selectedContractKey');
	getFromDataTableToHidden('viewAllVersionForm:previousVersionsTable','contractIdHid','viewAllVersionForm:selectedContractId');
	getFromDataTableToHidden('viewAllVersionForm:previousVersionsTable','contractDateSegmentSysHId','viewAllVersionForm:selectedContractDateSegSysId');
	getFromDataTableToHidden('viewAllVersionForm:previousVersionsTable','versionHid','viewAllVersionForm:selectedVersion');
...
async function showPopupForViewDS(page)
{	
getFromDataTableToHidden('ContractBasicSearchForm:searchResultTable','contractKey','ContractBasicSearchForm:contractKeyForDS');
getFromDataTableToHidden('ContractBasicSearchForm:searchResultTable','contractIdHid','ContractBasicSearchForm:contractIdForDS');
getFromDataTableToHidden('ContractBasicSearchForm:searchResultTable','versionHid','ContractBasicSearchForm:verionForDS');
...
myObject.comments = document.getElementById('ContractBasicSearchForm:comments').value;
myObject.type = document.getElementById('ContractBasicSearchForm:type').value;
var returnvalue=await window.showModalDialog(url,myObject,"dialogHeight:650px;dialogWidth:1000px;resizable=true;status=no;");
...
if(returnvalue == '3'){
	...
	var returnvalue1=await window.showModalDialog(url,myObject1,"dialogHeight:300px;dialogWidth:800px;resizable=true;status=no;");
	if(returnvalue1 == undefined){
		returnvalue1=""+"~"+"";
		getObj('ContractBasicSearchForm:searchButton').click();
	}
...
async function contractTierDefinition_ewpd(url, targetDiv, targetHidden, attrCount, attrPosn){
	var retVal = await  ewpdModalWindow_ewpd(url, targetDiv, targetHidden, attrCount, attrPosn);
	
	if(retVal!=null && retVal!=false  ){ 
		submitLink('contractCoverageForm:doRefreshLink');
		return false;
	} else {
		return false;
	}
