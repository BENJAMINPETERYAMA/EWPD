...
function contractSerchResultsActions(){
...
function productSerchResultsActions(){
	var retValue = window.showModalDialog('../product/productGeneralInformationView.jsp'+getUrl()+'?productKey='+document.getElementById('benefitComponentCreateForm:productKey').value + '&temp=' + Math.random(),'','dialogHeight:800px;dialogWidth:1000px;resizable=true;status=no;');
	if( retValue == undefined ) {
		return false;
	}
} 
function productStructureSerchResultsActions(){
	var currentDate = new Date();
	var currentTime = currentDate.getTime();
	var id = document.getElementById('benefitComponentCreateForm:productStructureId').value;
	var retValue = window.showModalDialog('../productStructure/viewProductStructureGeneralInformation.jsp'+getUrl()+'?id='+id+'&date='+currentTime,'','dialogHeight:800px;dialogWidth:1026px;resizable=false;status=no;');
		if( retValue == undefined ) {
			return false;
		}
}
function benefitComponentSerchResultsActions(){
	var retValue = window
	.showModalDialog(
...
function benefitSerchResultsActions(){
	var retValue = window.showModalDialog('../standardBenefit/standardBenefitView.jsp'+getUrl()+'?benefitkey='+document.getElementById('benefitComponentCreateForm:benefitKey').value + '&temp=' + Math.random(),'ViewStandardBenefit','dialogHeight:800px;dialogLeft:100px;dialogTop:100px;dialogWidth:1000px;resizable=true;status=no;');
	if( retValue == undefined ) {
		return false;
	}
}
...
function reserveContractNotAvailable(){
...
function releaseContractAvailable(){
...
function editQuestionnaire(){
	...
	var retvalue =  window.showModalDialog('../questionnaire/helperPopUp.jsp'+getUrl()+'?adminOptionName='+escape(document.getElementById('adminOptionQuestionForm:adminNameToNextPage').value)+'&adminOptionVersion='+document.getElementById('adminOptionQuestionForm:adminVersionToNextPage').value+'&parentQuestionnaireHierarchyId='+document.getElementById('adminOptionQuestionForm:selectedQuestionnaireId').value + '&temp=' + Math.random(),'EditQuestionnaire','dialogHeight:600px;dialogLeft:20px;dialogTop:60px;dialogWidth:1000px;scrollbars=false;resizable=false;status=no;');
	//submitLink('adminOptionQuestionForm:refreshLink');
...
var newMyObject=window.showModalDialog(url,myObject,"dialogHeight:800px;dialogWidth:1000px;resizable=true;status=no;");
...
submitLink('ContractBasicSearchForm:copyHeadingsLink');
 ...
 function contractTierDefinition_ewpd(url, targetDiv, targetHidden, attrCount, attrPosn){
	var retVal =   ewpdModalWindow_ewpd(url, targetDiv, targetHidden, attrCount, attrPosn);
