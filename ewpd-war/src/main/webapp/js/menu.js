...
// menu class for Product & Product Structure advance print
function menu_prod (a_items, a_tpl) {
	...
	this.onclick     = menu_onclick_prod;
	this.onmouseout  = menu_onmouseout;
	this.onmouseover = menu_onmouseover;
	this.onmousedown = menu_onmousedown;
...
function menu_onclick_prod (n_id) {	
	if (n_id == 1)
		productCommonPrint(false, false);
	else if (n_id == 2)		
		productCommonPrint(true, false);
	else if (n_id == 3)		
		productCommonPrint(false, true);
	return false;
}
// --------------------------------------------------------------------------------
